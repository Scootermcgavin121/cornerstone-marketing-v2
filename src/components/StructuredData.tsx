    ...
    "@graph": [
      {
        ...
        "offers": {
          ...
          "priceSpecification": [
            ...
            { "@type": "UnitPriceSpecification", "price": "499", "priceCurrency": "USD", "name": "Pro - With AI Agents", "description": "Adds Foreman AI (45+ skills), Blueprint AI (25 takeoffs/mo). Up to 1,000 active homes, unlimited users.", "billingDuration": "P1M" },
        ...
        "featureList": [
          ...
          "Foreman AI agent with 45+ purpose-built construction skills",
