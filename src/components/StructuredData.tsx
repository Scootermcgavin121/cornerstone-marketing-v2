    ...
    "@graph": [
      {
        ...
        "featureList": [
          ...
          "REST API with 500+ endpoints (growing) and 37+ named webhook event types (catalog growing)",
