    ...
    "@graph": [
      {
        ...
        "offers": {
          ...
          "priceSpecification": [
            ...
            { "@type": "UnitPriceSpecification", "price": "499", "priceCurrency": "USD", "name": "Pro - With AI Agents", "description": "Adds Foreman AI (117+ skills), Blueprint AI (25 takeoffs/mo). Up to 1,000 active homes, up to 30 users.", "billingDuration": "P1M" },
        ...
        "featureList": [
          ...
          "Foreman AI agent with 117+ purpose-built construction skills",
          ...
          "REST API with 40+ endpoints (growing) and 37+ named webhook event types (catalog growing)",
