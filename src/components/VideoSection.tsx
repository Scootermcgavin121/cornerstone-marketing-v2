        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Mute */}
              <button onClick={toggleMute} className="flex items-center gap-1.5 text-white/80 hover:text-white transition-colors text-xs font-semibold" aria-label={muted ? "Unmute" : "Mute"}>
                {muted ? (
                  <>
