...
const screens = [
  {
    ...
    headline: "Every home, every stage — one kanban board.",
    description:
      "Drag-and-drop sales pipeline from contract to construction. See every home in Sales, Permitting, Design, and Construction at a glance — buyer assigned, current task, community, lot. Filter by community, home type, or status. The board sales managers live in.",
  ...
  },
  {
    ...
    headline: "148 tasks. One Gantt. Auto-cascading dependencies.",
    description:
      "Pre-built templates per home type with full foundation through final-trade sequencing. Move one task and every downstream dependency reschedules. Color-coded scopes, milestone markers, dependency arrows, and Build vs Total Workday counters built in.",
  ...
  },
  {
    ...
    headline: "Unlimited spec levels. Per-community pricing.",
    description:
      "Set up Standard / Upgrade / Premium tiers (or as many spec levels as you sell), assign each community to its own tier, and Foreman AI rolls pricing forward. Buyers see real-time upgrade math on every room. No hand-keyed spreadsheets.",
