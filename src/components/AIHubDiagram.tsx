...
const AGENTS: Agent[] = [
  ...
  },
  {
    ...
    description: "Phone agent texts vendors when bids are due — 117+ skills exposed via Bearer token. Connect Claude, GPT, Twilio, anything.",
    href: "/api-access",
    color: "text-sky-300",
    bg: "bg-sky-500/15",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-14 sm:mb-20">
          ...
          <p className="mt-6 text-base sm:text-lg text-white/60 max-w-2xl mx-auto">
            <span className="text-cyan-300 font-semibold">Foreman AI™</span> is the brain behind Cornerstone — 117+ skills, 5 specialized agents, and a full REST API. Build your own phone agent, vendor SMS bot, or workflow automation on top of the same engine that runs your jobs.
          </p>
        </div>
