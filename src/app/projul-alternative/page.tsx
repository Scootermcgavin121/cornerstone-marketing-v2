...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Public REST API (500+ endpoints, growing)", cornerstone: true, competitor: false, note: "Cornerstone Pro+: 500+ endpoints and growing rapidly, public docs. New endpoints ship as the platform grows. Projul has no public API (Zapier integration only)." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Public API + 37+ webhooks (Pro+)", desc: "500+ REST endpoints, 37+ named webhook events with HMAC signatures -- both on Pro+ ($599/mo). Projul has no public API. Wire SMS, voice, or your own AI agent to your construction data." },
];
