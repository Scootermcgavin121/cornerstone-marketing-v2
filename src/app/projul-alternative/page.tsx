...
export const metadata = {
  title: "Projul Alternative for Production Home Builders | Cornerstone PM",
  description:
    "Projul is built for residential contractors. Cornerstone PM is the alternative for production home builders - AI agents, options engine, multi-community management, and 30 webhook events from $149/mo.",
  alternates: { canonical: "https://www.cornerstonepm.ai/projul-alternative" },
};

const comparisonRows: ComparisonRow[] = [
  { feature: "Built for production home builders", cornerstone: true, competitor: false, note: "Projul targets residential remodelers and small contractors. Cornerstone PM is purpose-built for production (tract/spec) home builders managing multiple communities." },
  ...
  { feature: "30+ named webhook events (catalog growing)", cornerstone: true, competitor: false, note: "30+ named events and counting — HMAC signatures, auto-retry. New events ship as the platform grows. Cornerstone Pro+." },
  ...
  { feature: "Starting price", cornerstone: "$149/mo", competitor: "$49/mo+", note: "Projul is cheaper but built for smaller remodeling contractors. Cornerstone is a full production builder platform." },
];

const whySwitchCards: WhySwitchCard[] = [
  { title: "Production builder workflows native", desc: "Lot management, floorplan pricing, structural options, design center, multi-community pipelines, pre-sale flow - first-class features in Cornerstone. None of these exist in Projul." },
  { title: "AI agents built in — 45+ skills", desc: "Foreman AI reads AND writes your data. Blueprint AI converts floor plans to takeoffs. Image search, anti-bot web scraping, and per-user memory that greets you by your chosen name and learns your habits over time — all custom-coded into the app. No other home builder platform comes close." },
...
const faqItems: FAQItem[] = [
  {
    q: "Is Projul a good fit for production home builders?",
    a: "Projul is designed for residential remodelers and small contractors. It handles scheduling, lead tracking, and invoicing well for renovation-type work. If you're a production home builder managing lot inventories, pre-sale selections, multi-community pipelines, and construction schedules across multiple floorplans, Projul lacks the specialized features you need.",
  },
  {
    q: "What's the best Projul alternative for production home builders?",
    a: "Cornerstone PM is purpose-built for production home builders. Beyond the basics (scheduling, CRM, client portal), it adds a structural options engine, floorplan pricing matrix, multi-community lot management, native AI agents (Foreman AI 45+ skills, Blueprint AI), 30 webhook events, and a public REST API with 59 endpoints.",
  },
  {
...
export default function ProjulAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      badgeLabel="Projul Alternative - Production Builders"
      heroLine1="Remodeling software won't cut it."
      heroLine2="You're building communities."
      accentColor="cyan"
      heroParagraph="Projul is built for residential remodelers and small contractors. Cornerstone PM is the Projul alternative for production home builders - structural options engine, floorplan pricing matrix, multi-community lot management, 45+ AI skills, and a public REST API from $149/mo."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="Projul vs Cornerstone PM - remodeling contractor tool vs. production builder platform."
      ...
      faqSubtitle="For production home builders evaluating Projul vs Cornerstone PM."
      faqItems={faqItems}
