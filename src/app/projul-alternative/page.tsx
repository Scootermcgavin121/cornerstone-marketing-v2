...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Native AI agents (Foreman AI -- 117+ skills)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): Foreman AI reads AND writes construction data. Blueprint AI: PDF to takeoff in 60 seconds. Projul has no native AI agents." },
  ...
  { feature: "Public REST API (40+ endpoints, growing)", cornerstone: true, competitor: false, note: "Cornerstone Pro+: 40+ endpoints and growing rapidly, public docs. New endpoints ship as the platform grows. Projul has no public API (Zapier integration only)." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Public API + 37+ webhooks (Pro+)", desc: "40+ REST endpoints, 37+ named webhook events with HMAC signatures -- both on Pro+ ($599/mo). Projul has no public API. Wire SMS, voice, or your own AI agent to your construction data." },
];
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PM™ is purpose-built for home builders. Beyond the basics (scheduling, CRM, client portal from Starter $149/mo), it adds a structural options engine, floorplan pricing matrix, multi-community lot management, native AI agents (Foreman AI 117+ skills on Pro $499/mo, Blueprint AI), 37+ named webhook events (Pro+), and a public REST API with 40+ endpoints (and growing).",
  },
  {
