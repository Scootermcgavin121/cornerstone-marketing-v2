...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "AI agents built in — 45+ skills", desc: "Foreman AI reads AND writes your data. Blueprint AI converts floor plans to takeoffs. Per-user memory, image search, anti-bot web scraping. No other production builder platform comes close." },
