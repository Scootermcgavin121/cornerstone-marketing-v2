...
export const metadata = {
  title: "JobNimbus Alternative for Home Builders | Cornerstone PMÃ¢â€žÂ¢",
  description:
    "JobNimbus is built for roofing and restoration. Cornerstone PMÃ¢â€žÂ¢ is the alternative for home builders -- AI agents (Pro $499/mo), options engine, and multi-community management from $149/mo.",
...
const faqItems: FAQItem[] = [
  {
    ...
    a: "JobNimbus is built primarily for roofing contractors, restoration companies, and home improvement businesses. If you're a home builder managing lot inventories, floorplans, pre-sale design centers, structural options, and multi-community schedules, JobNimbus will feel like a square peg in a round hole. Cornerstone PMÃ¢â€žÂ¢ is purpose-built for your workflows.",
  },
  {
  ...
  {
    q: "Does Cornerstone PMÃ¢â€žÂ¢ have a CRM like JobNimbus?",
    a: "Yes. Cornerstone PMÃ¢â€žÂ¢ includes a sales pipeline and CRM for managing leads, prospects, and buyers through pre-sale, design selection, contract, and construction phases. It's designed specifically for new home sales workflows, not roofing or restoration lead pipelines.",
  },
  {
...
export default function JobnimbusAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      honestAngle="If you're a roofing contractor or home improvement company, JobNimbus is probably fine. This page is for home builders who landed on JobNimbus because it showed up in a search -- you need a different tool, and that tool is Cornerstone PMÃ¢â€žÂ¢."
      ...
      faqSubtitle="Common questions from home builders evaluating JobNimbus vs Cornerstone PMÃ¢â€žÂ¢."
      faqItems={faqItems}
