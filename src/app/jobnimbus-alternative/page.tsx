...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PM™ is the purpose-built alternative for home builders. It includes CRM, scheduling, purchasing, bid management, homeowner portal, and document management -- plus a structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community lot management, and native AI agents (Foreman AI 396+ skills on Pro $499/mo, Blueprint AI) that JobNimbus doesn't offer.",
  },
  {
...
export default function JobnimbusAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="emerald"
      heroParagraph="JobNimbus is built for roofing and restoration contractors. Cornerstone PM™ is the home-builder alternative -- structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community lot management, 396+ AI skills (Pro $499/mo), and a public REST API (Pro+) from $149/mo."
