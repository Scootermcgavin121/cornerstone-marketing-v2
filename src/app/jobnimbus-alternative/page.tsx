...
export const metadata = {
  title: "JobNimbus Alternative for Home Builders | Cornerstone PMâ„¢",
  description:
    "JobNimbus is built for roofing and restoration. Cornerstone PMâ„¢ is the alternative for home builders -- AI agents (Pro $499/mo), options engine, and multi-community management from $149/mo.",
  alternates: { canonical: "https://www.cornerstonepm.ai/jobnimbus-alternative" },
};

const comparisonRows: ComparisonRow[] = [
  { feature: "Built for home builders", cornerstone: true, competitor: false, note: "JobNimbus is built for roofing, restoration, and home improvement contractors. Cornerstone PMâ„¢ is purpose-built for home builders -- production, semi-custom, and custom -- with lot management, options engine, and multi-community pipelines that roofing CRMs don't offer." },
  ...
  { feature: "Native AI agents (Foreman AI -- 396+ skills)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro ($499/mo): Foreman AI reads AND writes construction data -- 396+ skills. Blueprint AI: PDF to takeoff in 60 seconds. JobNimbus Scout (beta) is an in-app AI assistant with limited action-taking capability, focused on roofing/restoration workflows." },
  ...
  { feature: "37+ named webhook events (catalog growing)", cornerstone: true, competitor: false, note: "Cornerstone Pro+ ($599/mo): 37+ named events and counting -- typed payloads, HMAC signatures, delivery logs, auto-retry. New events ship as the platform grows. JobNimbus has webhook support but no named construction event catalog." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Action-taking AI on Pro -- 396+ skills", desc: "Foreman AI (Cornerstone Pro, $499/mo) reads AND writes your data. Blueprint AI converts floor plans to takeoffs. AI image search, vision, anti-bot web scraping. Per-user memory. JobNimbus Scout is in beta and roofing-focused." },
  { title: "Generous user caps, full platform", desc: "Scheduling from $149, purchasing, bid management, homeowner portal, design center (Builder $299), REST API + 37+ named webhook events (Pro+ $599) -- all in one platform with up to 30 users on Starter, Builder, Pro Â· 60 users on Pro+ (no per-seat fees within tier)." },
];

const faqItems: FAQItem[] = [
  {
    q: "Is JobNimbus a good fit for home builders?",
    a: "JobNimbus is built primarily for roofing contractors, restoration companies, and home improvement businesses. If you're a home builder managing lot inventories, floorplans, pre-sale design centers, structural options, and multi-community schedules, JobNimbus will feel like a square peg in a round hole. Cornerstone PMâ„¢ is purpose-built for your workflows.",
  },
  {
    q: "What's the best JobNimbus alternative for home builders?",
    a: "Cornerstone PMâ„¢ is the purpose-built alternative for home builders. It includes CRM, scheduling, purchasing, bid management, homeowner portal, and document management -- plus a structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community lot management, and native AI agents (Foreman AI 396+ skills on Pro $499/mo, Blueprint AI) that JobNimbus doesn't offer.",
  },
  {
    q: "Does JobNimbus have AI features?",
    a: "JobNimbus Scout (beta) is an in-app AI assistant designed for roofing and restoration contractors. Cornerstone's Foreman AI (Pro $499/mo) is a native agent with 396+ purpose-built construction skills that takes real actions -- creates purchase orders, updates design options, generates scope-of-work documents, runs bid comparisons, scrapes vendor product pages, analyzes screenshots with AI vision, and remembers preferences across sessions. Different markets, different capabilities.",
  },
  {
    q: "Can I migrate from JobNimbus to Cornerstone PMâ„¢?",
  ...
  {
    q: "Does Cornerstone PMâ„¢ have a CRM like JobNimbus?",
    a: "Yes. Cornerstone PMâ„¢ includes a sales pipeline and CRM for managing leads, prospects, and buyers through pre-sale, design selection, contract, and construction phases. It's designed specifically for new home sales workflows, not roofing or restoration lead pipelines.",
  },
  {
  ...
  {
    q: "Does Cornerstone PMâ„¢ have a free trial?",
...
export default function JobnimbusAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="emerald"
      heroParagraph="JobNimbus is built for roofing and restoration contractors. Cornerstone PMâ„¢ is the home-builder alternative -- structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community lot management, 396+ AI skills (Pro $499/mo), and a public REST API (Pro+) from $149/mo."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="JobNimbus vs Cornerstone PMâ„¢ -- roofing platform vs. home-builder platform."
      comparisonRows={comparisonRows}
      trademarkName="JobNimbus"
      whySwitchHeadline="What home builders get with Cornerstone PMâ„¢"
      whySwitchCards={whySwitchCards}
      honestAngle="If you're a roofing contractor or home improvement company, JobNimbus is probably fine. This page is for home builders who landed on JobNimbus because it showed up in a search -- you need a different tool, and that tool is Cornerstone PMâ„¢."
      ...
      faqSubtitle="Common questions from home builders evaluating JobNimbus vs Cornerstone PMâ„¢."
      faqItems={faqItems}
