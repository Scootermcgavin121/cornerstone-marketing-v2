...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Native AI agents (Foreman AI -- 117+ skills)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro ($499/mo): Foreman AI reads AND writes construction data -- 117+ skills. Blueprint AI: PDF to takeoff in 60 seconds. JobNimbus Scout (beta) is an in-app AI assistant with limited action-taking capability, focused on roofing/restoration workflows." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Action-taking AI on Pro -- 117+ skills", desc: "Foreman AI (Cornerstone Pro, $499/mo) reads AND writes your data. Blueprint AI converts floor plans to takeoffs. AI image search, vision, anti-bot web scraping. Per-user memory. JobNimbus Scout is in beta and roofing-focused." },
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PM™ is the purpose-built alternative for home builders. It includes CRM, scheduling, purchasing, bid management, homeowner portal, and document management -- plus a structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community lot management, and native AI agents (Foreman AI 117+ skills on Pro $499/mo, Blueprint AI) that JobNimbus doesn't offer.",
  },
  {
    q: "Does JobNimbus have AI features?",
    a: "JobNimbus Scout (beta) is an in-app AI assistant designed for roofing and restoration contractors. Cornerstone's Foreman AI (Pro $499/mo) is a native agent with 117+ purpose-built construction skills that takes real actions -- creates purchase orders, updates design options, generates scope-of-work documents, runs bid comparisons, scrapes vendor product pages, analyzes screenshots with AI vision, and remembers preferences across sessions. Different markets, different capabilities.",
  },
  {
...
export default function JobnimbusAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="emerald"
      heroParagraph="JobNimbus is built for roofing and restoration contractors. Cornerstone PM™ is the home-builder alternative -- structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community lot management, 117+ AI skills (Pro $499/mo), and a public REST API (Pro+) from $149/mo."
