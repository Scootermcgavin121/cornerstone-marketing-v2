...
export const metadata = {
  ...
  description:
    "See how Cornerstone PM™ stacks up against NEWSTAR, BuildPro, Buildertrend, and Buildxact. Less cost, faster setup, built specifically for home builders — with AI, real-time command center, and a 396+ skills in-app agent none of them have.",
};
