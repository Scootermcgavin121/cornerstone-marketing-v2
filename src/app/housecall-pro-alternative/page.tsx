...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Public REST API (500+ endpoints, growing)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 500+ endpoints and growing rapidly, public docs. New endpoints ship as the platform grows. purpose-built for construction. Housecall Pro: API on MAX plan, oriented toward home service workflows." },
