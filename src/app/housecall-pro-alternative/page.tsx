...
export const metadata = {
  title: "Housecall Pro Alternative for Home Builders | Cornerstone PMÃ¢â€žÂ¢",
  description:
    "Housecall Pro is built for home service businesses. Cornerstone PMÃ¢â€žÂ¢ is the alternative for home builders -- AI agents (Pro $499/mo), options engine, and multi-community management from $149/mo.",
  alternates: { canonical: "https://www.cornerstonepm.ai/housecall-pro-alternative" },
};

const comparisonRows: ComparisonRow[] = [
  { feature: "Built for home builders", cornerstone: true, competitor: false, note: "Housecall Pro is built for HVAC, plumbing, electrical, and home service businesses. Cornerstone PMÃ¢â€žÂ¢ is purpose-built for home builders -- production, semi-custom, and custom -- with lot management, options engine, and multi-community pipelines that home service tools don't offer." },
  ...
  { feature: "Native AI agents (Foreman AI -- 396+ skills)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro ($499/mo): Foreman AI reads AND writes construction data -- 396+ skills. Blueprint AI: PDF to takeoff in 60 seconds. Housecall Pro has AI Team features (CSR AI, call answering) for home service dispatch -- different market, different purpose." },
  ...
  { feature: "Public REST API (150+ API endpoints)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 150+ API endpoints, public docs. New endpoints ship as the platform grows. purpose-built for construction. Housecall Pro: API on MAX plan, oriented toward home service workflows." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "AI agents for builders -- Pro $499/mo", desc: "Foreman AI (396+ skills) creates POs, updates design options, generates SOWs, and remembers your preferences. Blueprint AI converts PDF floor plans to takeoffs. Built for construction workflows, not service call scheduling." },
...
const faqItems: FAQItem[] = [
  ...
  {
    q: "What does Cornerstone PMÃ¢â€žÂ¢ have that Housecall Pro doesn't?",
    a: "For home builders: structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community lot management, pre-sale design center with 64 Designer Packages curated by an actual interior designer, Blueprint AI floor plan takeoffs, Foreman AI with 396+ skills (Pro $499/mo), 37+ named webhook events (Pro+), public REST API (Pro+), a no-login vendor portal (vendors confirm tasks, accept schedule changes, and submit bids via email magic links Ã¢â‚¬â€ no app, no account, no password), and one-click full database export (CSV/JSON).",
  },
  {
    q: "Can I migrate my Housecall Pro data to Cornerstone PMÃ¢â€žÂ¢?",
...
export default function HousecallProAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="cyan"
      heroParagraph="Housecall Pro is a home service platform for HVAC, plumbing, and electrical companies. Cornerstone PMÃ¢â€žÂ¢ is the alternative for home builders -- structural options engine (Builder $299/mo), floorplan pricing, 396+ AI skills (Pro $499/mo), and multi-community management from $149/mo."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="Housecall Pro vs Cornerstone PMÃ¢â€žÂ¢ -- home services vs. new home construction."
      ...
      honestAngle="If you're a home service business (HVAC, plumbing, electrical, cleaning), Housecall Pro is probably a good fit. This page is for home builders who landed on Housecall Pro through a search. You need different software -- Cornerstone PMÃ¢â€žÂ¢ is built for your workflows."
