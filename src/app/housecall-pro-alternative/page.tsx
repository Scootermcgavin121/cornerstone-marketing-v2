...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Native AI agents (Foreman AI -- 110+ skills)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro ($499/mo): Foreman AI reads AND writes construction data -- 110+ skills. Blueprint AI: PDF to takeoff in 60 seconds. Housecall Pro has AI Team features (CSR AI, call answering) for home service dispatch -- different market, different purpose." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "AI agents for builders -- Pro $499/mo", desc: "Foreman AI (110+ skills) creates POs, updates design options, generates SOWs, and remembers your preferences. Blueprint AI converts PDF floor plans to takeoffs. Built for construction workflows, not service call scheduling." },
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "For home builders: structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community lot management, pre-sale design center with 64 Designer Packages curated by an actual interior designer, Blueprint AI floor plan takeoffs, Foreman AI with 110+ skills (Pro $499/mo), 37+ named webhook events (Pro+), public REST API (Pro+), a no-login vendor portal (vendors confirm tasks, accept schedule changes, and submit bids via email magic links — no app, no account, no password), and one-click full database export (CSV/JSON).",
  },
  {
