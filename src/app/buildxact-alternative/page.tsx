...
export const metadata = {
  title: "Buildxact Alternative for Home Builders | Cornerstone PMTM",
  description:
    "Buildxact focuses on takeoffs and estimating. Cornerstone PMTM adds full construction PM, native AI agents (Pro $499/mo), options engine, and 37+ named webhook events - from $149/mo.",
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "MCP server, 37+ webhooks + public API on Pro+", desc: "Built-in MCP server (connect Claude Desktop, Cursor, or Windsurf in ~30 seconds), 37+ named webhook events with typed payload schemas, HMAC signatures, and auto-retry on Pro+ ($599/mo) - catalog growing. Public REST API with 150+ API endpoints. Wire your own tools, SMS bots, or AI agents. Buildxact has no comparable automation layer." },
];

const faqItems: FAQItem[] = [
  {
    q: "How is Cornerstone PMTM different from Buildxact?",
    a: "Buildxact is primarily an estimating and takeoff platform (starting $199/mo annual) with scheduling and job management on higher tiers. Cornerstone PMTM is a full construction management platform for home builders - it includes takeoff (Blueprint AI on Pro $499/mo), estimating, scheduling (from Starter $149/mo), homeowner portal, design center, purchasing, bid management, multi-community pipeline, and native AI agents. Buildxact has Blu AI for estimating assistance; Cornerstone's Foreman AI takes real actions across your entire construction operation.",
  },
  {
    q: "Does Cornerstone PMTM do takeoffs like Buildxact?",
  ...
  {
    q: "Can I migrate from Buildxact to Cornerstone PMTM?",
  ...
  {
    q: "Is Cornerstone PMTM a good fit if I'm growing from custom to production building?",
...
export default function BuildxactAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="emerald"
      heroParagraph="Buildxact is great at takeoffs and quotes (from $199/mo). Cornerstone PMTM is the Buildxact alternative that adds full construction management: scheduling from $149/mo, homeowner portal, purchasing, bid management, options engine (Builder $299/mo), and Foreman AI with 100+ action-taking skills (Pro $499/mo) - all in one platform."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="Buildxact vs Cornerstone PMTM - takeoff tool vs. full home-builder platform."
      comparisonRows={comparisonRows}
      trademarkName="Buildxact"
      whySwitchHeadline="Why builders move from Buildxact to Cornerstone PMTM"
      ...
      faqSubtitle="Common questions from builders evaluating Cornerstone PMTM vs Buildxact."
      faqItems={faqItems}
