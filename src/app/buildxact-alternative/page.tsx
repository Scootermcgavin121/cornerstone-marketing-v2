...
export const metadata = {
  title: "Buildxact Alternative for Home Builders | Cornerstone PMÃ¢â€žÂ¢",
  description:
    "Buildxact focuses on takeoffs and estimating. Cornerstone PMÃ¢â€žÂ¢ adds full construction PM, native AI agents (Pro $499/mo), options engine, and 30+ named webhook events - from $149/mo.",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "30+ named webhook events (catalog growing)", cornerstone: true, competitor: false, note: "Cornerstone Pro+ ($599/mo): 30+ named events and counting Ã¢â‚¬â€ typed payloads, HMAC signatures, delivery logs, auto-retry. New events ship as the platform grows. Buildxact has no public webhook catalog." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Blueprint AI + Foreman AI = AI native on Pro", desc: "Blueprint AI converts PDF floor plans to material takeoffs in 60 seconds. Foreman AI (99+ skills on Pro $499/mo) reads and writes your data - SOWs, bid comparisons, design options, image search, web scraping. Buildxact's Blu AI stays within estimating scope." },
  { title: "30+ webhooks + public API on Pro+", desc: "30+ named webhook events with typed payload schemas, HMAC signatures, and auto-retry on Pro+ ($599/mo) Ã¢â‚¬â€ catalog growing. Public REST API with 59+ endpoints and growing. Wire your own tools, SMS bots, or AI agents. Buildxact has no comparable automation layer." },
];

const faqItems: FAQItem[] = [
  {
    q: "How is Cornerstone PMÃ¢â€žÂ¢ different from Buildxact?",
    a: "Buildxact is primarily an estimating and takeoff platform (starting $199/mo annual) with scheduling and job management on higher tiers. Cornerstone PMÃ¢â€žÂ¢ is a full construction management platform for home builders - it includes takeoff (Blueprint AI on Pro $499/mo), estimating, scheduling (from Starter $149/mo), homeowner portal, design center, purchasing, bid management, multi-community pipeline, and native AI agents. Buildxact has Blu AI for estimating assistance; Cornerstone's Foreman AI takes real actions across your entire construction operation.",
  },
  {
    q: "Does Cornerstone PMÃ¢â€žÂ¢ do takeoffs like Buildxact?",
  ...
  {
    q: "Can I migrate from Buildxact to Cornerstone PMÃ¢â€žÂ¢?",
  ...
  {
    q: "Is Cornerstone PMÃ¢â€žÂ¢ a good fit if I'm growing from custom to production building?",
...
export default function BuildxactAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="emerald"
      heroParagraph="Buildxact is great at takeoffs and quotes (from $199/mo). Cornerstone PMÃ¢â€žÂ¢ is the Buildxact alternative that adds full construction management: scheduling from $149/mo, homeowner portal, purchasing, bid management, options engine (Builder $299/mo), and Foreman AI with 99+ action-taking skills (Pro $499/mo) - all in one platform."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="Buildxact vs Cornerstone PMÃ¢â€žÂ¢ - takeoff tool vs. full home-builder platform."
      comparisonRows={comparisonRows}
      trademarkName="Buildxact"
      whySwitchHeadline="Why builders move from Buildxact to Cornerstone PMÃ¢â€žÂ¢"
      ...
      faqSubtitle="Common questions from builders evaluating Cornerstone PMÃ¢â€žÂ¢ vs Buildxact."
      faqItems={faqItems}
