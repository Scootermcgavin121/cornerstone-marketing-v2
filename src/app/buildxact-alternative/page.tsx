...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Public REST API (60+ endpoints, growing)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 60+ endpoints and growing rapidly, public docs. New endpoints ship as the platform grows. Buildxact: limited API access." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "37+ webhooks + public API on Pro+", desc: "37+ named webhook events with typed payload schemas, HMAC signatures, and auto-retry on Pro+ ($599/mo) — catalog growing. Public REST API with 60+ endpoints and growing. Wire your own tools, SMS bots, or AI agents. Buildxact has no comparable automation layer." },
];
