...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "30+ webhooks + public API on Pro+", desc: "30+ named webhook events with typed payload schemas, HMAC signatures, and auto-retry on Pro+ ($599/mo) — catalog growing. Public REST API with 60+ endpoints and growing. Wire your own tools, SMS bots, or AI agents. Buildxact has no comparable automation layer." },
];
