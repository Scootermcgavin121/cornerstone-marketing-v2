...
export const metadata = {
  ...
  description:
    "Buildxact focuses on takeoffs and estimating. Cornerstone PM adds full construction PM, native AI agents (Pro $499/mo), options engine, and 30 webhook events — from $149/mo.",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "AI image search + anti-bot web scraping", cornerstone: true, competitor: false, note: "Foreman searches product images, hosts them on CDN, and reads supplier product pages with AI-powered web scraping. Cornerstone Pro feature." },
  { feature: "30 webhook events (full named catalog)", cornerstone: true, competitor: false, note: "Cornerstone Pro+ ($599/mo): 30 named events, HMAC signatures, delivery logs, auto-retry. Buildxact has no public webhook catalog." },
  ...
  { feature: "Public REST API (59 endpoints)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 59 endpoints, public docs. Buildxact: limited API access." },
  ...
  { feature: "Starter price", cornerstone: "$149/mo", competitor: "$199/mo (Foundation, annual)", note: "Cornerstone Starter: scheduling, permits, homeowner portal — unlimited users. Buildxact Foundation: estimating + takeoffs, unlimited users — $199/mo billed annually ($239/mo monthly)." },
  { feature: "Full platform price (Builder)", cornerstone: "$299/mo", competitor: "$399/mo (Pro, annual)", note: "Cornerstone Builder ($299/mo) adds sales pipeline, purchasing, design center, options engine. Buildxact Pro ($399/mo annual) adds scheduling, job management, site management." },
  { feature: "Price at full AI tier (Pro)", cornerstone: "$499/mo", competitor: "$499/mo+ (Master + Blu add-ons)", note: "Cornerstone Pro ($499/mo): Foreman AI (45+ skills) + Blueprint AI, flat. Buildxact Master ($599/mo annual) + Blu Takeoff Assistant (+$99/mo) + Estimate Reviewer (+$149/mo) — full AI stack could exceed $800/mo." },
];
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "30 webhooks + public API on Pro+", desc: "30 named webhook events with typed payload schemas, HMAC signatures, and auto-retry on Pro+ ($599/mo). Public REST API with 59 endpoints. Wire your own tools, SMS bots, or AI agents. Buildxact has no comparable automation layer." },
];
