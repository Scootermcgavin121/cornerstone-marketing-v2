...
export const metadata = {
  ...
  description:
    "Buildxact focuses on takeoffs and estimating. Cornerstone PM™ adds full construction PM, native AI agents (Pro $499/mo), options engine, and 37+ named webhook events - from $149/mo.",
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "37+ webhooks + public API on Pro+", desc: "37+ named webhook events with typed payload schemas, HMAC signatures, and auto-retry on Pro+ ($599/mo) — catalog growing. Public REST API with 150+ API endpoints. Wire your own tools, SMS bots, or AI agents. Buildxact has no comparable automation layer." },
];
...
export default function BuildxactAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="emerald"
      heroParagraph="Buildxact is great at takeoffs and quotes (from $199/mo). Cornerstone PM™ is the Buildxact alternative that adds full construction management: scheduling from $149/mo, homeowner portal, purchasing, bid management, options engine (Builder $299/mo), and Foreman AI with 100+ action-taking skills (Pro $499/mo) - all in one platform."
