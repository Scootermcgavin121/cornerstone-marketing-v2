...
export const metadata = {
  title: "Buildxact Alternative for Home Builders | Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢",
  description:
    "Buildxact focuses on takeoffs and estimating. Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ adds full construction PM, native AI agents (Pro $499/mo), options engine, and 37+ named webhook events - from $149/mo.",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "37+ named webhook events (catalog growing)", cornerstone: true, competitor: false, note: "Cornerstone Pro+ ($599/mo): 37+ named events and counting ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â typed payloads, HMAC signatures, delivery logs, auto-retry. New events ship as the platform grows. Buildxact has no public webhook catalog." },
  ...
  { feature: "Public REST API (150+ API endpoints)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 150+ API endpoints, public docs. New endpoints ship as the platform grows. Buildxact: limited API access." },
  ...
  { feature: "Vendor portal ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no login required (email magic links)", cornerstone: true, competitor: false, note: "Vendors confirm tasks, accept schedule changes, and submit bids ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â all via secure magic links sent straight to their email. No app to download, no account to create, no password to remember. Click the link, do the thing, done. Biggest friction-killer for trade partners in the industry." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Blueprint AI + Foreman AI = AI native on Pro", desc: "Blueprint AI converts PDF floor plans to material takeoffs in 60 seconds. Foreman AI (396+ skills on Pro $499/mo) reads and writes your data - SOWs, bid comparisons, design options, image search, web scraping. Buildxact's Blu AI stays within estimating scope." },
  { title: "37+ webhooks + public API on Pro+", desc: "37+ named webhook events with typed payload schemas, HMAC signatures, and auto-retry on Pro+ ($599/mo) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â catalog growing. Public REST API with 150+ API endpoints. Wire your own tools, SMS bots, or AI agents. Buildxact has no comparable automation layer." },
];

const faqItems: FAQItem[] = [
  {
    q: "How is Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ different from Buildxact?",
    a: "Buildxact is primarily an estimating and takeoff platform (starting $199/mo annual) with scheduling and job management on higher tiers. Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ is a full construction management platform for home builders - it includes takeoff (Blueprint AI on Pro $499/mo), estimating, scheduling (from Starter $149/mo), homeowner portal, design center, purchasing, bid management, multi-community pipeline, and native AI agents. Buildxact has Blu AI for estimating assistance; Cornerstone's Foreman AI takes real actions across your entire construction operation.",
  },
  {
    q: "Does Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ do takeoffs like Buildxact?",
  ...
  {
    q: "Can I migrate from Buildxact to Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢?",
  ...
  {
    q: "Is Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ a good fit if I'm growing from custom to production building?",
...
export default function BuildxactAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="emerald"
      heroParagraph="Buildxact is great at takeoffs and quotes (from $199/mo). Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ is the Buildxact alternative that adds full construction management: scheduling from $149/mo, homeowner portal, purchasing, bid management, options engine (Builder $299/mo), and Foreman AI with 100+ action-taking skills (Pro $499/mo) - all in one platform."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="Buildxact vs Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ - takeoff tool vs. full home-builder platform."
      comparisonRows={comparisonRows}
      trademarkName="Buildxact"
      whySwitchHeadline="Why builders move from Buildxact to Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢"
      ...
      faqSubtitle="Common questions from builders evaluating Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ vs Buildxact."
      faqItems={faqItems}
