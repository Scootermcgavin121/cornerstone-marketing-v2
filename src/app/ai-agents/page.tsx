...
export const metadata: Metadata = {
  ...
  description:
    "6 AI agents for home builders: Foreman AI (117+ skills), Blueprint AI (PDF takeoffs), Bid Import AI (parses any vendor bid), AI MLS Listing Generator, AI Support Agent, plus Jobsite AI (coming soon). Native AI built into the platform — not bolted on.",
...
const agents = [
  {
    ...
    href: "/foreman",
    highlights: [
      "117+ skills covering parts, vendors, homes & budgets",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Photo evidence auto-attached to task audit log",
    ],
    badge: "Coming Soon",
  },
];
...
const pricingTiers = [
  {
    name: "Starter",
    price: "$149",
    agents: ["AI Support Agent"],
    color: "text-slate-300",
  },
  {
    name: "Builder",
    price: "$299",
    agents: ["AI Support Agent", "AI MLS Listing"],
  ...
  },
  {
    name: "Pro",
    price: "$499",
    agents: ["AI Support Agent", "AI MLS Listing", "Foreman AI", "Blueprint AI"],
      ...
      <section className="py-20 px-4 bg-slate-900/40">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-400">Every plan includes AI Support Agent. AI MLS Listing Generator on Builder+. Foreman AI + Blueprint AI on Pro. Bid Import AI + full API automation on Pro+.</p>
          </div>
