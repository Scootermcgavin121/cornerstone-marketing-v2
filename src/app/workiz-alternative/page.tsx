...
export const metadata = {
  ...
  description:
    "Workiz is built for field service businesses. Cornerstone PM is the alternative for production new home builders â€” AI agents, options engine, and multi-community management from $149/mo.",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Structural options engine", cornerstone: true, competitor: false, note: "Pre-sale floorplan options pricing matrix â€” not a field service concept." },
  ...
  { feature: "Native AI agents (Foreman AI â€” 45+ skills)", cornerstone: true, competitor: false, note: "Foreman AI reads AND writes data. Blueprint AI: PDF to takeoff in 60 seconds." },
  ...
  { feature: "30+ named webhook events (catalog growing)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 30+ named events and counting â€” HMAC signatures, auto-retry. New events ship as the platform grows." },
  { feature: "Public REST API (59+ endpoints, growing)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 59+ endpoints and growing rapidly, public docs. New endpoints ship as the platform grows." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "AI agents native â€” 45+ skills", desc: "Foreman AI (45+ skills) creates POs, updates design options, generates SOWs, and remembers preferences. Blueprint AI converts floor plans to takeoffs in 60 seconds. No other production builder platform comes close." },
  { title: "30+ webhooks + public API", desc: "30+ named webhook events with typed payload schemas and HMAC signatures (catalog growing). Wire your own SMS, voice, or AI agents. Public REST API with 59+ endpoints and growing rapidly." },
];

const faqItems: FAQItem[] = [
  {
    q: "Is Workiz a good fit for home builders?",
    a: "Workiz is built for field service businesses â€” locksmith, appliance repair, carpet cleaning, garage door. Its strengths are dispatch, call tracking, and service scheduling. If you're a home builder, Workiz lacks the features you need: structural options engine, floorplan pricing matrix, pre-sale design center, construction scheduling, and multi-community pipelines.",
  },
  {
    q: "What's the best Workiz alternative for new home builders?",
    a: "Cornerstone PM is purpose-built for home builders. It covers scheduling, client portal, and document management â€” plus a structural options engine, floorplan pricing matrix, multi-community lot management, native AI agents (Foreman AI 45+ skills, Blueprint AI), 30 webhook events, and a public REST API.",
  },
  {
...
export default function WorkizAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      badgeLabel="Workiz Alternative â€” Home Builders"
      heroLine1="Workiz is for field service."
      heroLine2="You build homes."
      accentColor="rose"
      heroParagraph="Workiz is built for locksmiths, appliance repair, and field service businesses. Cornerstone PM is the alternative for production new home builders â€” structural options engine, floorplan pricing, 45+ AI skills, and multi-community management from $149/mo."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="Workiz vs Cornerstone PM â€” field service platform vs. production builder platform."
      comparisonRows={comparisonRows}
      trademarkName="Workiz"
      whySwitchHeadline="What home builders get with Cornerstone PM"
      whySwitchCards={whySwitchCards}
      honestAngle="If you're a field service business â€” locksmith, appliance repair, carpet cleaning â€” Workiz is a solid tool. This page is for home builders who found Workiz through a search. You need a different platform, and Cornerstone PM is built for your workflows."
