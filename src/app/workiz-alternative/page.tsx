...
export const metadata = {
  title: "Workiz Alternative for Home Builders | Cornerstone PMÃ¢â€žÂ¢",
  description:
    "Workiz is built for field service businesses. Cornerstone PMÃ¢â€žÂ¢ is the alternative for home builders -- AI agents (Pro $499/mo), options engine, and multi-community management from $149/mo.",
  alternates: { canonical: "https://www.cornerstonepm.ai/workiz-alternative" },
};

const comparisonRows: ComparisonRow[] = [
  { feature: "Built for home builders", cornerstone: true, competitor: false, note: "Workiz is built for locksmith, appliance repair, carpet cleaning, and other field service businesses. Cornerstone PMÃ¢â€žÂ¢ is purpose-built for home builders -- production, semi-custom, and custom -- with lot management, options engine, and multi-community pipelines." },
  ...
  { feature: "Native AI agents (Foreman AI -- 396+ skills)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): Foreman AI reads AND writes construction data. Blueprint AI: PDF to takeoff in 60 seconds. Workiz has no native construction AI agents." },
  ...
  { feature: "37+ named webhook events (catalog growing)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+ ($599/mo): 37+ named events and counting -- typed payloads, HMAC signatures, delivery logs, auto-retry. New events ship as the platform grows. Workiz: limited webhook support for field service workflows." },
  { feature: "Public REST API (150+ API endpoints)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 150+ API endpoints, public docs. New endpoints ship as the platform grows. purpose-built for construction. Workiz: limited API access for field service integrations." },
  ...
  { feature: "Pricing model", cornerstone: "Flat Ã¢â‚¬â€ up to 30 users (60 on Pro+)", competitor: "Contact for pricing", note: "Workiz does not publish pricing publicly -- contact for current rates. Cornerstone is flat at every tier Ã¢â‚¬â€ up to 30 users (60 on Pro+) from $149. More importantly: Workiz doesn't ship an options engine, floorplan pricing matrix, multi-community pipelines, or home-builder AI at any price." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "AI agents native -- Pro $499/mo", desc: "Foreman AI (396+ skills) creates POs, updates design options, generates SOWs, and remembers preferences. Blueprint AI converts floor plans to takeoffs in 60 seconds. No other home-builder platform comes close." },
  { title: "37+ webhooks + public API (Pro+)", desc: "37+ named webhook events with typed payload schemas and HMAC signatures. Wire your own SMS, voice, or AI agents. Public REST API with 150+ API endpoints -- both on Pro+ ($599/mo)." },
];
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PMÃ¢â€žÂ¢ is purpose-built for home builders. It covers scheduling, client portal, and document management -- plus a structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community lot management, native AI agents (Foreman AI 396+ skills on Pro $499/mo, Blueprint AI), 37+ named webhook events (Pro+), and a public REST API.",
  },
  {
    q: "Can I migrate from Workiz to Cornerstone PMÃ¢â€žÂ¢?",
...
export default function WorkizAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="rose"
      heroParagraph="Workiz is built for locksmiths, appliance repair, and field service businesses. Cornerstone PMÃ¢â€žÂ¢ is the alternative for home builders -- structural options engine (Builder $299/mo), floorplan pricing, 396+ AI skills (Pro $499/mo), and multi-community management from $149/mo."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="Workiz vs Cornerstone PMÃ¢â€žÂ¢ -- field service platform vs. home-builder platform."
      comparisonRows={comparisonRows}
      trademarkName="Workiz"
      whySwitchHeadline="What home builders get with Cornerstone PMÃ¢â€žÂ¢"
      whySwitchCards={whySwitchCards}
      honestAngle="If you're a field service business -- locksmith, appliance repair, carpet cleaning -- Workiz is a solid tool. This page is for home builders who found Workiz through a search. You need a different platform, and Cornerstone PMÃ¢â€žÂ¢ is built for your workflows."
