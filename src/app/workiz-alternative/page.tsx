...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Public REST API (500+ endpoints, growing)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 500+ endpoints and growing rapidly, public docs. New endpoints ship as the platform grows. purpose-built for construction. Workiz: limited API access for field service integrations." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "37+ webhooks + public API (Pro+)", desc: "37+ named webhook events with typed payload schemas and HMAC signatures. Wire your own SMS, voice, or AI agents. Public REST API with 500+ endpoints -- both on Pro+ ($599/mo)." },
];
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PM™ is purpose-built for home builders. It covers scheduling, client portal, and document management -- plus a structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community lot management, native AI agents (Foreman AI 100+ skills on Pro $499/mo, Blueprint AI), 37+ named webhook events (Pro+), and a public REST API.",
  },
  {
