...
export const metadata = {
  ...
  description:
    "110+ purpose-built construction skills with built-in memory compaction - the only construction AI that doesn't forget mid-session. Reads and writes your real data: parts, vendors, homes, budgets, sales pipeline, design center selections. Pro plan.",
};
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-amber-500/30 bg-amber-500/10 text-amber-400 text-xs font-semibold mb-6">
            ...
            110+ skills &middot; PRO PLAN &middot; READS AND WRITES YOUR REAL DATA
          </div>
          ...
          <p className="text-xl text-slate-400 max-w-3xl mx-auto mb-10 leading-relaxed">
            110+ purpose-built skills across 16 categories &mdash; data, analysis, document generation, takeoffs, bidding, sales, reports, system intelligence and more. Type what you need in plain English. Foreman executes it against your real data.
          </p>
      ...
      <section className="py-12 px-4">
        <div className="max-w-5xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-5">
          {[
            { num: "110+", label: "Purpose-built skills", sub: "Not generic AI features" },
      ...
      <section id="skills" className="py-16 px-4 bg-slate-900/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl sm:text-5xl font-black mb-4">110+ skills. 16 categories.</h2>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="rounded-2xl bg-slate-900/60 border border-amber-500/20 p-8 text-center">
            ...
            <div className="space-y-3 text-left mb-8">
              {[
                "Foreman AI - 110+ skills on the latest Claude Sonnet model, 1,000 AI messages/mo",
      ...
      <section className="py-20 px-4 text-center border-t border-slate-800/60">
        ...
        <p className="text-slate-400 text-lg mb-10 max-w-xl mx-auto">
          We built the consultant into the software. 110+ skills. Plain English. Real construction data. Pro plan.
        </p>
