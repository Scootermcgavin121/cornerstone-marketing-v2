...
export const metadata = {
  title: "Support AI — Always-On AI Knowledge Agent | Cornerstone PM",
  description:
    "Support AI is the always-on AI knowledge agent built into Cornerstone PM. Knows every feature, workflow, and permission. Answers buyer and team questions 24/7 in plain English — included on every plan.",
...
const features = [
  { title: "Trained on Cornerstone PM", desc: "Not a generic LLM. Support AI is grounded in Cornerstone's actual feature documentation, workflows, and permission matrix — so the answers you get match the app you're actually using." },
  ...
  { title: "Included Everywhere", desc: "Starter, Builder, Pro, Pro+ — Support AI is on every plan. No add-on, no usage caps, no surprise bill." },
];

const faq: FAQItem[] = [
  {
    q: "What is Support AI?",
    a: "Support AI is the always-on AI knowledge agent built into Cornerstone PM. It's trained on the platform's complete feature documentation, workflow guides, and permission matrix, so it can answer any \"how do I do X?\" question about Cornerstone in plain English — from a team member, a buyer, or a vendor — 24/7.",
  },
  {
    q: "How is this different from a chatbot like ChatGPT?",
    a: "ChatGPT doesn't know what a takeoff scope is, what a phase gate inspection means in your sequence, or who in your tenant can edit base pricing. Support AI is grounded in Cornerstone's actual feature set, your workflows, and your permission matrix. The answers match the app you're actually using.",
  },
  {
    q: "Where does Support AI live?",
  ...
  },
  {
    ...
    a: "Anything documented in Cornerstone PM: setting up vendors, creating bid requests, locking structural options, generating MLS listings, configuring permitting sequences, managing the options engine, running design center, the auto-budget flow, role permissions, notification settings, and the full purchasing → bid → PO pipeline. If a feature exists, Support AI can explain it.",
  },
  {
    q: "Does it answer buyer questions too?",
    a: "Yes. Buyers using the buyer portal ask things like \"when is my drywall walk?\" or \"what's a phase gate?\" or \"can I still change my flooring?\" and Support AI answers using the buyer's actual home data plus the platform's workflow knowledge.",
  },
  {
    q: "Is my data used to train the AI?",
    a: "No. Support AI runs on a model with training disabled. Your conversations, your permission matrix, your tenant data — none of it leaves your tenant for training purposes. Each conversation is isolated.",
  },
  {
    q: "What plan is Support AI on?",
    a: "Every plan. Starter ($149/mo), Builder ($299/mo), Pro ($499/mo), and Pro+ ($599/mo) all include Support AI with no usage caps. It's the baseline AI that comes free with Cornerstone — the rest of the AI lineup (MLS Listing, Foreman AI, Blueprint AI, Bid Import AI) layers in at higher tiers.",
  },
  {
    q: "How does this reduce my support load?",
    a: "Most builder support tickets are \"how do I…\" questions — the kind a documented platform should answer instantly. Support AI handles those automatically, so your team only escalates when something's actually broken or genuinely outside the docs. Builders running Support AI in beta saw 60-80% deflection on routine \"how to\" tickets.",
  },
];
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="py-20 px-4 bg-slate-900/40">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-black mb-3">What Support AI knows</h2>
      ...
      <section className="py-24 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl text-slate-400 mb-10">Support AI ships on every plan. Free your team from &ldquo;how do I&hellip;&rdquo; questions for good.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/beta" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-cyan-400 text-slate-900 font-bold text-lg hover:from-cyan-400 hover:to-cyan-300 shadow-lg shadow-cyan-500/25 transition-all duration-200">
              Request Early Access <ArrowRight className="w-5 h-5" />
            </Link>
