...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Native AI agents (Foreman AI + Blueprint AI)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): 117+ Foreman AI skills that read AND write data, plus Blueprint AI floor plan takeoffs in 60 sec. Procore's AI features are commercial-focused and limited in residential scope." },
  ...
  { feature: "Public REST API (40+ endpoints, growing)", cornerstone: true, competitor: true, note: "Both offer REST APIs. Cornerstone Pro+: purpose-built for residential workflows (40+ endpoints and growing rapidly). Procore's is commercial-focused." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Residential-native AI on Pro", desc: "Foreman AI (Cornerstone Pro, $499/mo) has 117+ skills specific to home building: design options, vendor bids, takeoffs, buyer allowances, scope management, profitability reports. Not generic construction AI - residential-native." },
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PM™ is purpose-built for residential home builders. It covers the project management backbone you need (scheduling, purchasing, bid management, homeowner portal, document management) and adds features Procore doesn't offer: a structural options engine, 64 Designer Packages curated by an actual interior designer (the same playbook K. Hovnanian Homes uses), native AI agents (Foreman AI 117+ skills on Pro $499/mo, Blueprint AI), and a public REST API with 37+ named webhook events (Pro+).",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Cornerstone PM™'s REST API (Pro+ plan, $599/mo): 40+ endpoints and growing rapidly, 37+ named webhook events (catalog growing), HMAC signatures, scoped Bearer-token auth, and public documentation - oriented toward residential: floorplans, options, lot management, buyer selections, bid requests, vendor assignments. Procore also has an API, but it's oriented toward commercial construction workflows.",
  },
  {
