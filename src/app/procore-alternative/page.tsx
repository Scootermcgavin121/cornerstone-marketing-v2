...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Designer Packages (64 curated by an interior designer, 7 categories)", cornerstone: true, competitor: false, note: "Residential buyer selections, packages curated by an actual interior designer (the same playbook K. Hovnanian Homes uses) — not a Procore feature." },
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PM is purpose-built for residential production home builders. It covers the project management backbone you need (scheduling, purchasing, bid management, homeowner portal, document management) and adds features Procore doesn't offer: a structural options engine, 64 Designer Packages curated by an actual interior designer (the same playbook K. Hovnanian Homes uses), native AI agents (Foreman AI 45+ skills, Blueprint AI), and a public REST API with 30 webhook events.",
  },
  {
