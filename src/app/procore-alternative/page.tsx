...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Native AI agents (Foreman AI + Blueprint AI)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): 110+ Foreman AI skills that read AND write data, plus Blueprint AI floor plan takeoffs in 60 sec. Procore's AI features are commercial-focused and limited in residential scope." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Residential-native AI on Pro", desc: "Foreman AI (Cornerstone Pro, $499/mo) has 110+ skills specific to home building: design options, vendor bids, takeoffs, buyer allowances, scope management, profitability reports. Not generic construction AI - residential-native." },
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PM™ is purpose-built for residential home builders. It covers the project management backbone you need (scheduling, purchasing, bid management, homeowner portal, document management) and adds features Procore doesn't offer: a structural options engine, 64 Designer Packages curated by an actual interior designer (the same playbook K. Hovnanian Homes uses), native AI agents (Foreman AI 110+ skills on Pro $499/mo, Blueprint AI), and a public REST API with 37+ named webhook events (Pro+).",
  },
  {
