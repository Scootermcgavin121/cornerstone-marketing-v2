...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Native AI agents (Foreman AI + Blueprint AI)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): 45+ Foreman AI skills that read AND write data, plus Blueprint AI floor plan takeoffs in 60 sec. Procore's AI features are commercial-focused and limited in residential scope." },
  ...
  { feature: "30 webhook events (full named catalog)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+ ($599/mo): 30 named events, HMAC signatures, delivery logs. Procore has webhooks but limited residential-specific events." },
  ...
  { feature: "Public REST API (59 endpoints)", cornerstone: true, competitor: true, note: "Both offer REST APIs. Cornerstone Pro+: purpose-built for residential workflows (59 endpoints). Procore's is commercial-focused." },
  ...
  { feature: "Free database export (CSV / JSON)", cornerstone: true, competitor: "limited", note: "Cornerstone: full CSV/JSON export anytime + nightly 7-day backups. Procore: data portability limited without custom extraction." },
  ...
  { feature: "Starter price", cornerstone: "$149/mo", competitor: "Custom quote", note: "Cornerstone Starter: scheduling, permits, homeowner portal — unlimited users. Procore does not publish pricing; contact for a quote." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Residential-native AI on Pro", desc: "Foreman AI (Cornerstone Pro, $499/mo) has 45+ skills specific to home building: design options, vendor bids, takeoffs, buyer allowances, scope management, profitability reports. Not generic construction AI — residential-native." },
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PM is purpose-built for residential home builders. It covers the project management backbone you need (scheduling, purchasing, bid management, homeowner portal, document management) and adds features Procore doesn't offer: a structural options engine, 64 Designer Packages curated by an actual interior designer (the same playbook K. Hovnanian Homes uses), native AI agents (Foreman AI 45+ skills on Pro $499/mo, Blueprint AI), and a public REST API with 30 webhook events (Pro+).",
  },
  {
