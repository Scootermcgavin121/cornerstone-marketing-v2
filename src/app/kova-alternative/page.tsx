...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Land acquisition & land development module", cornerstone: false, competitor: true, note: "KOVA tracks land acquisition activities, ownership history, dev budgets, bonds and bond releases. This is a genuine enterprise capability for builders who develop their own land. Cornerstone doesn't ship a land-dev module today — we focus on home build workflow from contract to warranty." },
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "KOVA tracks land acquisition activities, ownership history, development budgets, and bonds/bond releases — useful for builders who self-develop land. Cornerstone doesn't ship a land-dev module today. We focus on home build workflow from contract through warranty. If land development is a core part of your business, KOVA covers it natively; you'd pair Cornerstone with a separate tool for that piece (or wait — it's on the roadmap).",
  },
  {
