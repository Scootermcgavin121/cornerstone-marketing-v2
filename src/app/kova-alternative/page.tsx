...
export const metadata = {
  title: "MiTek KOVA Alternative for Small-to-Mid Home Builders | Cornerstone PM™",
  description:
    "MiTek KOVA alternative for home builders. Same scope — sales, options, purchasing, scheduling, vendor portal — plus native AI agents. From $149/mo, no hidden enterprise quote, no consultant-led implementation.",
  alternates: { canonical: "https://www.cornerstonepm.ai/kova-alternative" },
};

const comparisonRows: ComparisonRow[] = [
  { feature: "Public, transparent pricing", cornerstone: "$149 / $299 / $499 / $599 — listed", competitor: "Hidden — consult-only", note: "Cornerstone publishes every tier on the website. KOVA requires a sales consultation just to learn what it costs. For a small-to-mid home builder evaluating tools, hidden pricing is itself a feature gap — you can't compare what you can't see." },
  { feature: "Sign up today (no sales call required)", cornerstone: true, competitor: false, note: "Cornerstone is self-serve — pick a plan, sign up, you're in tonight. KOVA gates access behind 'Request a Demo' and a MiTek Services consultation cycle." },
  { feature: "Implementation cost", cornerstone: "$0", competitor: "Consultant-led implementation (MiTek Services)", note: "KOVA's own page promotes that 'MiTek Services professionals help with data implementation and ongoing maintenance' — code for paid services on top of license fees. Cornerstone has zero implementation cost on every tier." },
  ...
  { feature: "Built for small-to-mid home builders (5–200 homes/yr)", cornerstone: true, competitor: false, note: "KOVA's reference customer is Fischer Homes — a top-30 production builder doing thousands of homes per year. KOVA is genuinely built for enterprise production builders. Cornerstone is built for the 5–200 homes/yr builders who need KOVA-scope capabilities without enterprise pricing or implementation." },
  { feature: "Native AI agents (Foreman AI + Blueprint AI)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): 396+ Foreman AI skills that read AND write data, plus Blueprint AI floor plan takeoffs in 60 seconds. KOVA has a workflow rules engine, not AI agents — different category of product." },
  ...
  { feature: "37+ named webhook events (catalog growing)", cornerstone: true, competitor: "Limited", note: "Cornerstone Pro+ ($599/mo): 37+ named events and counting — typed payloads, HMAC signatures, delivery logs, auto-retry. KOVA advertises 'flexible API connections' but no public webhook catalog." },
  ...
  { feature: "Built-in accounting / GL", cornerstone: "Integrate via API (QuickBooks, etc.)", competitor: true, note: "KOVA ships a real ERP-grade accounting module — full GL, AP/AR, retainage, lien waivers, COGS, intercompany transactions, bank reconciliation, financial statements. This is a legitimate KOVA strength for builders running 300+ homes/yr who need an in-platform GL. Cornerstone integrates with your existing accounting system via our REST API instead — appropriate for the 5–200 homes/yr builder who already runs QuickBooks or similar." },
  { feature: "Land development scheduling & tracking", cornerstone: true, competitor: true, note: "Both platforms handle land development scheduling — clearing, grading, utilities, paving, etc. — with full phase tracking once you own the dirt. Cornerstone builds it into the same scheduling engine as the rest of the build." },
  { feature: "Land acquisition lead tracking (ownership history, bonds, bond releases)", cornerstone: "Not yet", competitor: true, note: "KOVA tracks land acquisition activities, ownership history, and bond / bond-release lifecycles — a genuine enterprise capability for builders who run a land-acquisition pipeline. Cornerstone handles land-dev scheduling and tracking today, but the dirt-pursuit CRM piece (parcels, ownership history, bonds) is on the roadmap, not in the product yet. We're honest about it." },
  ...
  { feature: "Public REST API (40+ endpoints, growing)", cornerstone: true, competitor: "Limited public docs", note: "Cornerstone Pro+: 40+ public REST endpoints with public docs, growing rapidly. KOVA advertises 'API functionality' and an 'Accounting API plug-in module' but no public endpoint catalog — integrations typically go through MiTek Services." },
  ...
  { feature: "Per-user fees", cornerstone: "Up to 30 users (60 on Pro+), every tier", competitor: "Unlimited users (their advertised strength)", note: "KOVA makes a real point of unlimited internal + external users, which is genuinely useful for a 300+ homes/yr operation with hundreds of vendors. For a 5–200 homes/yr builder, Cornerstone's 30-user cap (60 on Pro+) covers your whole team plus extended vendors without per-seat scaling." },
  ...
  { feature: "Pricing model", cornerstone: "Flat — published online", competitor: "Enterprise quote + implementation services", note: "KOVA: enterprise contract, consult-led pricing, MiTek Services for implementation and ongoing maintenance. Cornerstone: flat monthly, published online, self-serve onboarding, no implementation fee." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Public API + 37+ webhooks on Pro+", desc: "40+ REST endpoints (growing), 37+ named webhook events (catalog growing), HMAC signatures, public docs. Wire Twilio, Bland, Retell, or your own agents to our webhooks. KOVA APIs go through MiTek Services as integrations engagements." },
];

const faqItems: FAQItem[] = [
  {
    q: "What is the best MiTek KOVA alternative for home builders?",
    a: "Cornerstone PM™ is the closest functional KOVA alternative for small-to-mid home builders. It includes the same core capabilities — options rules engine, sales pipeline with contract management, estimating, purchasing with bidding, multi-community management, construction scheduling, vendor collaboration, and warranty — without KOVA's enterprise quote and MiTek Services implementation engagement. Cornerstone adds native AI agents (Foreman AI 396+ skills on Pro $499/mo, Blueprint AI 60-second takeoffs), 37+ named webhook events (Pro+), and a public REST API (Pro+). Pricing is published online starting at $149/mo.",
  },
  {
    q: "Is Cornerstone PM™ a KOVA replacement?",
    a: "For builders running 5–200 homes/yr, yes. Cornerstone covers KOVA's core homebuilder workflows — sales rules engine, design center, estimating/takeoffs, purchasing & POs, scheduling, vendor collaboration, homeowner portal, warranty — in a modern AI-native platform. For enterprise builders running 300+ homes/yr who need an in-platform general ledger and a full land acquisition / bonds / land development module, KOVA's ERP-grade accounting and land-dev modules are genuine strengths and may be the right fit. We're honest about the segmentation: KOVA is built for production enterprise; Cornerstone is built for the small-to-mid builder.",
  },
  {
    q: "How much does Cornerstone PM™ cost compared to KOVA?",
    a: "Cornerstone PM™ starts at $149/mo (Starter, up to 30 users) with zero implementation cost. KOVA pricing is not publicly listed — MiTek requires a consultation to get a quote, and implementation goes through MiTek Services as a paid engagement. For the full Cornerstone platform: Builder ($299/mo, options engine + full pipeline) and Pro ($499/mo, Foreman AI + Blueprint AI) are flat within tier (up to 30 users / 60 on Pro+). Pro+ at $599/mo includes the REST API, 37+ named webhook events, and BYOA.",
  },
  {
    q: "Does Cornerstone PM™ have a vendor portal like KOVA?",
    a: "Yes, but built differently. KOVA gives vendors a login to a portal where they can export, update, and import costs, plus see plans, options, schedules, and POs. Cornerstone replaces the login with tokenized magic links — vendors get a secure link in email, click once, and bid or confirm tasks without an account or password. Adoption is dramatically higher when subs don't have to manage yet another login. For builders who prefer a full vendor portal experience, that's also available.",
  },
  {
    q: "What about KOVA's built-in accounting? Does Cornerstone match it?",
    a: "Honestly: no, and we don't try to. KOVA ships a real ERP-grade accounting module with full GL, AP/AR, retainage, lien waivers, COGS, intercompany transactions, and bank reconciliation. That's a genuine fit for enterprise production builders who want their accounting and operations on one platform. Cornerstone is built for the 5–200 homes/yr builder who already runs QuickBooks or a similar accounting system — we integrate with your existing accounting via our public REST API (Pro+) rather than replace it. If you need an in-platform GL, KOVA is the right tool. If you want modern operations + AI on top of the accounting system you already have, Cornerstone is.",
  },
  {
    q: "What about KOVA's land development module?",
    a: "Two halves to this question. (1) Land development scheduling and tracking — clearing, grading, utilities, paving — Cornerstone handles natively through the same scheduling engine that runs the rest of the build. You can run a development phase end-to-end. (2) Land acquisition lead tracking — ownership history, parcel pursuit, bonds and bond releases — KOVA ships that; Cornerstone doesn't yet. It's on the roadmap. For builders whose dirt pipeline is already managed elsewhere (or who run smaller acquisition volumes), Cornerstone covers the operational side; for builders running a heavy land-acquisition pipeline with bond tracking, KOVA's module is currently the more complete fit on that specific piece.",
  },
  {
    q: "Does Cornerstone PM™ have an options rules engine like KOVA?",
    a: "Yes. Cornerstone Builder ($299/mo) ships a structural and design options engine with dependencies, incompatibilities, allowance overages, per-community pricing, and real-time price rollup as buyers select — same core mechanics KOVA's rules engine handles. Foreman AI's Design Center domain (Pro $499/mo) adds plain-English option configuration and 64 Designer Packages curated by an actual interior designer.",
  },
  {
    q: "Can I migrate from KOVA to Cornerstone?",
    a: "Yes. The AI Migration Wizard handles KOVA exports, plus NEWSTAR, BuildPro, MarkSystems, Buildertrend, CoConstruct, JobTread, and any CSV/Excel. Drop your files in, AI auto-detects column mapping, runs 23 dedicated import endpoints covering vendors, homes, communities, scopes, takeoffs, parts catalog, budgets, design categories, floorplans, warranties, and more. ~$0.01 per migration — we absorb it. White-glove migration available on Pro and Pro+ plans.",
  },
  {
...
export default function KovaAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="cyan"
      heroParagraph="Cornerstone PM™ is the modern, AI-native alternative to MiTek KOVA for small-to-mid home builders. Same core scope — options rules engine, sales pipeline, estimating, purchasing, scheduling, vendor collaboration, warranty — plus native AI agents (Foreman AI on Pro $499/mo), 37+ named webhook events (Pro+), and a public REST API (Pro+ $599/mo). Pricing published online from $149/mo. No MiTek Services consultation required."
      ...
      migrationDesc="Export your KOVA data, drag the files into our wizard, and AI auto-maps every column across vendors, homes, communities, design options, scopes, and budgets. Dry-run before you commit. ~$0.01 per migration — we absorb it. No MiTek Services engagement required."
      faqTitle="MiTek KOVA Alternative FAQ"
      faqSubtitle="Common questions about switching to Cornerstone PM™ from MiTek KOVA."
      faqItems={faqItems}
