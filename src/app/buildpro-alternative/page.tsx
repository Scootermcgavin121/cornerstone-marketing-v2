...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Most BuildPro migrations to Cornerstone PM complete in under a week, self-serve — and the new AI Migration Agent (Live in Beta) makes it even faster. Drop your BuildPro export files in and the agent reads them, maps the columns, and runs the imports for you. Behind the scenes it routes through 23 dedicated CSV import endpoints (vendors, homes, communities, schedule templates, master tasks, scopes, takeoffs, parts catalog, budgets, warranties, design categories, floorplans, and more) plus a CRM migration wizard that orchestrates 17 of them in one guided flow. Supports BuildPro exports, NEWSTAR, MarkSystems, and any Excel-based system. AI bid import handles whatever doesn't fit a CSV — upload any vendor format (Excel, PDF, scanned, handwritten) and Cornerstone parses it. White-glove migration available on Pro and Pro+ plans.",
  },
  {
  ...
  },
  {
    ...
    a: "Cornerstone PM offers a fully public REST API on the Pro+ plan ($599/mo): 59 endpoints, 30 webhook event types, scoped Bearer-token auth, public documentation at app.cornerstonepm.ai/developers. BuildPro offers enterprise integrations only, typically on a custom contract basis.",
  },
  {
