...
export const metadata = {
  title: "BuildPro Alternative for Home Builders | Cornerstone PMâ„¢",
  description:
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Native AI agents (Foreman AI + Blueprint AI)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): 99+ Foreman AI skills that read AND write data, plus Blueprint AI floor plan takeoffs in 60 sec. BuildPro has no native AI." },
  ...
  { feature: "30+ named webhook events (catalog growing)", cornerstone: true, competitor: false, note: "Cornerstone Pro+ ($599/mo): 30+ named events and counting â€” typed payloads, HMAC signatures, delivery logs, auto-retry. New events ship as the platform grows. BuildPro offers no public webhook catalog." },
  ...
  { feature: "Bid management + vendor portal", cornerstone: true, competitor: true, note: "Cornerstone Pro+ adds 7-wave automated bidding + a no-login vendor portal: vendors confirm tasks, accept schedule changes, and submit bids via secure email magic links â€” no app, no account, no password." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Action-taking AI on Pro - 99+ skills", desc: "Foreman AI (Cornerstone Pro, $499/mo) reads AND writes data. Blueprint AI converts PDF floor plans to material takeoffs in under 60 seconds. No third-party AI plugins, no separate subscriptions." },
...
const faqItems: FAQItem[] = [
  {
    ...
    a: "Cornerstone PMâ„¢ is the closest functional BuildPro alternative for small-to-mid home builders. It includes the same core capabilities - options engine, floorplan pricing matrix, multi-community management, sales pipeline, purchasing, and construction scheduling - plus native AI agents (Foreman AI on Pro $499/mo, Blueprint AI) and a public REST API (Pro+), without BuildPro's enterprise implementation cost.",
  },
  {
    q: "How is Cornerstone PMâ„¢ different from BuildPro?",
    a: "Three key differences: (1) Cornerstone PMâ„¢ is a modern, web-based, mobile-friendly platform, while BuildPro is built on a Windows desktop architecture; (2) Cornerstone ships native AI agents (Foreman AI 99+ skills on Pro $499/mo, Blueprint AI, AI image search, anti-bot web scraping) that BuildPro doesn't offer at any tier; (3) Cornerstone is operational in hours at $149/mo with unlimited users, while BuildPro requires $25k-$75k+ implementation budgets.",
  },
  {
    q: "Can Cornerstone PMâ„¢ replace BuildPro for a home builder?",
    a: "Yes - for small-to-mid home builders. Cornerstone PMâ„¢ covers BuildPro's core production builder workflows: lots, models, options, plan repeats, design center, draws, multi-community pipelines. For top-100 enterprise builders with deep custom integrations to existing ERPs, BuildPro may still be the right fit.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Cornerstone PMâ„¢'s options engine (Builder plan, $299/mo) handles structural and design options per floorplan, dependencies, incompatibilities, allowance overages, per-community pricing, and real-time price rollup. Foreman AI's Design Center domain (Pro $499/mo) adds plain-English option configuration and 64 Designer Packages curated by an actual interior designer (the same playbook K. Hovnanian Homes uses) across 7 categories - something BuildPro doesn't offer.",
  },
  {
    q: "Is Cornerstone PMâ„¢ mobile-friendly?",
    a: "Yes. Cornerstone PMâ„¢ is fully responsive on any device - PMs update from the jobsite, vendors confirm from their phone, sales counselors present floorplans on a tablet. BuildPro's mobile experience is limited and largely Windows-desktop focused.",
  },
  {
    q: "Does Cornerstone PMâ„¢ have a public API like BuildPro?",
    a: "Cornerstone PMâ„¢ offers a fully public REST API on the Pro+ plan ($599/mo): 59+ endpoints and growing, 30+ named webhook event types (catalog growing), HMAC signatures, scoped Bearer-token auth, and public documentation. BuildPro offers enterprise integrations only, typically on a custom contract basis.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Cornerstone PMâ„¢ offers a 2-year free beta to the first 100 home builders - no credit card, no contract, no implementation fee.",
  },
];
...
export default function BuildProAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="violet"
      heroParagraph="Cornerstone PMâ„¢ is the modern BuildPro alternative for small-to-mid home builders. Same core capabilities - options engine, multi-community pipelines, purchasing, construction scheduling - on a web-native platform with Foreman AI (99+ skills on Pro $499/mo), Blueprint AI, and a public REST API (Pro+ $599/mo). Starts at $149/mo, unlimited users."
      ...
      faqSubtitle="Common questions about switching to Cornerstone PMâ„¢ from BuildPro."
      faqItems={faqItems}
