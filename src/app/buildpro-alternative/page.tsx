...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Most BuildPro migrations to Cornerstone PM complete in under a week, self-serve — and the new AI Migration Wizard (Live in Beta) makes it even faster. Drop your BuildPro export files in and the wizard reads them, maps the columns, and runs the imports for you. Behind the scenes it routes through 23 dedicated CSV import endpoints (vendors, homes, communities, schedule templates, master tasks, scopes, takeoffs, parts catalog, budgets, warranties, design categories, floorplans, and more) covering 17 core data types. Supports BuildPro exports, NEWSTAR, MarkSystems, and any Excel-based system. AI bid import handles whatever doesn't fit a CSV — upload any vendor format (Excel, PDF, scanned, handwritten) and Cornerstone parses it. White-glove migration available on Pro and Pro+ plans.",
  },
  {
