...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Native AI agents (Foreman AI + Blueprint AI)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): 117+ Foreman AI skills that read AND write data, plus Blueprint AI floor plan takeoffs in 60 sec. BuildPro has no native AI." },
  ...
  { feature: "Public REST API (40+ endpoints, growing)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 40+ endpoints and growing rapidly, public docs. New endpoints ship as the platform grows. BuildPro: enterprise integrations only." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Action-taking AI on Pro - 117+ skills", desc: "Foreman AI (Cornerstone Pro, $499/mo) reads AND writes data. Blueprint AI converts PDF floor plans to material takeoffs in under 60 seconds. No third-party AI plugins, no separate subscriptions." },
  { title: "Public REST API + 37+ webhooks on Pro+", desc: "40+ REST endpoints (growing), 37+ named webhook events (catalog growing), HMAC signatures, and public documentation on Pro+ ($599/mo). BuildPro integrations are enterprise-contract only." },
];
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Three key differences: (1) Cornerstone PM™ is a modern, web-based, mobile-friendly platform, while BuildPro is built on a Windows desktop architecture; (2) Cornerstone ships native AI agents (Foreman AI 117+ skills on Pro $499/mo, Blueprint AI, AI image search, anti-bot web scraping) that BuildPro doesn't offer at any tier; (3) Cornerstone is operational in hours at $149/mo with up to 30 users (60 on Pro+), while BuildPro requires $25k-$75k+ implementation budgets.",
  },
  {
  ...
  },
  {
    ...
    a: "Cornerstone PM™ offers a fully public REST API on the Pro+ plan ($599/mo): 40+ endpoints and growing, 37+ named webhook event types (catalog growing), HMAC signatures, scoped Bearer-token auth, and public documentation. BuildPro offers enterprise integrations only, typically on a custom contract basis.",
  },
  {
