...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Yes — and Cornerstone's AI Migration Wizard (Live in Beta) makes it dramatically simpler than NEWSTAR's enterprise rollout. Drop your NEWSTAR export files in, the wizard reads them, maps the columns, runs the imports, and tells you what it skipped. Behind the scenes it routes through 23 dedicated CSV import endpoints (vendors, homes, communities, schedule templates, master tasks, scopes, takeoffs, parts catalog, budgets, design categories, floorplans, warranties, users, and more) covering 17 core data types in one guided flow. The same tooling that ingests NEWSTAR exports also handles BuildPro, MarkSystems, and any Excel-based system. AI bid import covers anything that doesn't fit a CSV — upload PDFs, scans, even handwritten quotes. White-glove migration available on Pro and Pro+ plans.",
  },
  {
