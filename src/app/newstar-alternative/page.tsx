...
export const metadata = {
  title: "NEWSTAR Alternative for Small-to-Mid Home Builders | Cornerstone PMâ„¢",
  description:
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Native AI agents (Foreman AI + Blueprint AI)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): 99+ Foreman AI skills that read AND write data, plus Blueprint AI floor plan takeoffs in 60 sec. NEWSTAR has no native AI." },
  ...
  { feature: "30+ named webhook events (catalog growing)", cornerstone: true, competitor: false, note: "Cornerstone Pro+ ($599/mo): 30+ named events and counting â€” typed payloads, HMAC signatures, delivery logs, auto-retry. New events ship as the platform grows. NEWSTAR offers no public webhook catalog." },
  ...
  { feature: "Public REST API (59+ endpoints, growing)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 59+ endpoints and growing rapidly, public docs. New endpoints ship as the platform grows. NEWSTAR: enterprise integrations only." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Action-taking AI on Pro - 99+ skills", desc: "Foreman AI (Cornerstone Pro, $499/mo) reads AND writes data, remembers your preferences, analyzes images, and scrapes product pages with AI-powered web scraping. Blueprint AI converts floor plans to takeoffs in 60 seconds. NEWSTAR has no native AI." },
  { title: "Public REST API + 30+ webhooks on Pro+", desc: "59+ REST endpoints (growing), 30+ named webhook events (catalog growing), HMAC signatures, and public docs on Pro+ ($599/mo). NEWSTAR integrations are enterprise-contract only. Wire Twilio or your own agents to our webhooks." },
];

const faqItems: FAQItem[] = [
  {
    q: "What is the best NEWSTAR alternative for home builders?",
    a: "Cornerstone PMâ„¢ is the closest functional NEWSTAR alternative for small-to-mid home builders. It includes the same core capabilities - options engine, floorplan pricing matrix, multi-community management, sales pipeline, purchasing, and construction scheduling - without NEWSTAR's $25,000-$100,000+ implementation cost. Cornerstone PMâ„¢ also adds native AI agents (Foreman AI 99+ skills on Pro $499/mo, Blueprint AI), 30+ named webhook events (Pro+), and a public REST API (Pro+).",
  },
  {
    q: "Is Cornerstone PMâ„¢ a NEWSTAR replacement?",
    a: "For small-to-mid home builders, yes. Cornerstone PMâ„¢ covers NEWSTAR's core home builder workflows - lots, models, options, plan repeats, design center, draws, multi-community pipelines - in a modern web platform with native AI (Pro $499/mo). For top-100 enterprise builders with deep custom integrations to existing ERPs, NEWSTAR may still be the right fit.",
  },
  {
    q: "How much does Cornerstone PMâ„¢ cost compared to NEWSTAR?",
    a: "Cornerstone PMâ„¢ starts at $149/mo (Starter, unlimited users) with zero implementation cost. NEWSTAR pricing is enterprise-quoted and not publicly listed, but typical NEWSTAR implementations run $25,000-$100,000+ before monthly licensing. For the full platform: Cornerstone Builder ($299/mo, options engine + full pipeline) and Cornerstone Pro ($499/mo, Foreman AI + Blueprint AI) are flat regardless of team size. Pro+ at $599/mo includes the REST API, 30+ named webhook events, and BYOA - capabilities NEWSTAR offers only at the enterprise tier.",
  },
  {
    q: "Can Cornerstone PMâ„¢ handle production builder workflows?",
    a: "Yes. Cornerstone PMâ„¢ was built with production-style workflows in mind - lot inventories, floorplan pricing matrices, structural options engines, design center allowances, draw schedules, and multi-community pipelines are first-class concepts in the platform. Semi-custom and custom builders with repeating floorplans benefit just as much.",
  },
  {
    q: "Does Cornerstone PMâ„¢ support BuildPro and MarkSystems migrations too?",
...
export default function NewstarAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="violet"
      heroParagraph="Cornerstone PMâ„¢ is the modern NEWSTAR and BuildPro alternative for small-to-mid home builders. Same core capabilities - options engine, floorplan pricing matrix, multi-community management - plus native AI agents (Foreman AI on Pro $499/mo), 30+ named webhook events (Pro+), and a public REST API (Pro+ $599/mo). Starts at $149/mo, unlimited users, operational in hours not months."
      ...
      faqSubtitle="Common questions about switching to Cornerstone PMâ„¢ from NEWSTAR or BuildPro."
      faqItems={faqItems}
