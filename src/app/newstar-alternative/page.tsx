...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Public REST API (59 endpoints)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 59 endpoints, public docs. NEWSTAR: enterprise integrations only." },
