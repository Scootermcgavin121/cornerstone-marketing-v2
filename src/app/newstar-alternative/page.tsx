...
export const metadata = {
  title: "NEWSTAR Alternative for Small-to-Mid Home Builders | Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢",
  description:
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Native AI agents (Foreman AI + Blueprint AI)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): 396+ Foreman AI skills that read AND write data, plus Blueprint AI floor plan takeoffs in 60 sec. NEWSTAR has no native AI." },
  ...
  { feature: "37+ named webhook events (catalog growing)", cornerstone: true, competitor: false, note: "Cornerstone Pro+ ($599/mo): 37+ named events and counting ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â typed payloads, HMAC signatures, delivery logs, auto-retry. New events ship as the platform grows. NEWSTAR offers no public webhook catalog." },
  ...
  { feature: "Public REST API (150+ API endpoints)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 150+ API endpoints, public docs. New endpoints ship as the platform grows. NEWSTAR: enterprise integrations only." },
  ...
  { feature: "Pricing model", cornerstone: "Flat ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â up to 30 users (60 on Pro+)", competitor: "Enterprise quote + implementation", note: "NEWSTAR requires enterprise contracts plus $25kÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“$100k+ implementation fees. Cornerstone starts at $149/mo, self-serve, zero implementation cost. More importantly: NEWSTAR is built for top-100 enterprise builders ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â small-to-mid home builders can't get this product at any accessible price point, regardless of what features they compare." },
...
const faqItems: FAQItem[] = [
  {
    ...
    a: "Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ is the closest functional NEWSTAR alternative for small-to-mid home builders. It includes the same core capabilities - options engine, floorplan pricing matrix, multi-community management, sales pipeline, purchasing, and construction scheduling - without NEWSTAR's $25,000-$100,000+ implementation cost. Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ also adds native AI agents (Foreman AI 396+ skills on Pro $499/mo, Blueprint AI), 37+ named webhook events (Pro+), and a public REST API (Pro+).",
  },
  {
    q: "Is Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ a NEWSTAR replacement?",
    a: "For small-to-mid home builders, yes. Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ covers NEWSTAR's core home builder workflows - lots, models, options, plan repeats, design center, draws, multi-community pipelines - in a modern web platform with native AI (Pro $499/mo). For top-100 enterprise builders with deep custom integrations to existing ERPs, NEWSTAR may still be the right fit.",
  },
  {
    q: "How much does Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ cost compared to NEWSTAR?",
  ...
  {
    q: "Can Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ handle production builder workflows?",
    a: "Yes. Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ was built with production-style workflows in mind - lot inventories, floorplan pricing matrices, structural options engines, design center allowances, draw schedules, and multi-community pipelines are first-class concepts in the platform. Semi-custom and custom builders with repeating floorplans benefit just as much.",
  },
  {
    q: "Does Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ support BuildPro and MarkSystems migrations too?",
...
export default function NewstarAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="violet"
      heroParagraph="Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ is the modern NEWSTAR and BuildPro alternative for small-to-mid home builders. Same core capabilities - options engine, floorplan pricing matrix, multi-community management - plus native AI agents (Foreman AI on Pro $499/mo), 37+ named webhook events (Pro+), and a public REST API (Pro+ $599/mo). Starts at $149/mo, up to 30 users (60 on Pro+), operational in hours not months."
      ...
      faqSubtitle="Common questions about switching to Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ from NEWSTAR or BuildPro."
      faqItems={faqItems}
