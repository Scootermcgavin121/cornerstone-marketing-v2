...
const purchasingSchema = buildFeatureSchema({
  ...
  featureList: [
    ...
    "QuickBooks Online sync (live) — one-way push of POs, Bills, sales tax, vendors, and job costs into QuickBooks, with construction-grade job costing per home and community (REST API and Zapier also available)",
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Yes — Cornerstone PM™ has a live QuickBooks Online integration. Connect in one click (no developer setup), then Purchase Orders, Bills, sales tax, vendors, and homes push one direction from Cornerstone into QuickBooks — Cornerstone stays your source of truth, and changes made in QuickBooks never overwrite it. It auto-builds a construction-ready Chart of Accounts from your scopes and cost codes, and syncs each Community as a QuickBooks Customer with each Home nested under it as a Project so you get true per-home and per-community P&L in QuickBooks. It adapts to your QuickBooks plan (POs need Plus or Advanced) and can pull your existing accounts, items, and vendors so it matches your books. Prefer to build your own sync instead? The REST API and Zapier webhooks (qboId fields, po.created, payment.created events) are available too.",
  },
  {
