...
const endpointGroups = [
...

  {
    ...
    endpoints: [
      ...
      { method: "GET", path: "/api/ext/skills", desc: "Get all Foreman AI skill definitions", detail: "?format=anthropic (default) | ?format=openai | ?format=openapi — Returns 396+ skills across 20 categories, including domain-aware tools like Setup Lighting Package (room-by-room fixture intelligence), Bid Comparison, Profitability Reports, and Image Vision. Auto-syncs as new skills ship. Pro+ only." },
...
const integrations = [
  ...
  { emoji: "🪖", title: "Built for AI Agents", desc: "Foreman AI uses this API internally with 396+ skills. Any AI agent - LangChain, AutoGen, Claude, GPT-4o - can connect via Bearer token." },
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
            ...
            <a href="https://app.cornerstonepm.ai/developers" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-4 rounded-xl bg-slate-900/60 border border-cyan-500/20 hover:border-cyan-500/50 transition-all duration-200 text-left group">
              ...
              <div>
                ...
                <div className="text-white font-bold text-sm group-hover:text-cyan-400 transition-colors">/developers →</div>
            ...
            <a href="https://app.cornerstonepm.ai/skills" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-4 rounded-xl bg-slate-900/60 border border-violet-500/20 hover:border-violet-500/50 transition-all duration-200 text-left group">
              ...
              <div>
                ...
                <div className="text-white font-bold text-sm group-hover:text-violet-400 transition-colors">/skills →</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="p-8">
                ...
                <p className="text-slate-400 leading-relaxed mb-4">
                  ...
                  All API requests require a Bearer token. Create scoped API keys in <strong className="text-white">Admin → API Keys</strong>. Each key has specific permissions so you can restrict what each integration can do.
  ...
  -H "Content-Type: application/json"`}</pre>
      ...
      <section id="endpoints" className="py-16 px-4">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-slate-500 text-center text-sm mb-12">Plus <code className="text-violet-400">POST /api/ext/execute</code> — a generic endpoint that runs any of Foreman&apos;s 396+ skills by name. Built on 110+ database tables — every endpoint reflects real construction data.</p>
                      ...
                      {group.endpoints.map((ep) => (
                        ...
                        <div key={ep.path} className="px-6 py-4 hover:bg-slate-800/20 transition-colors">
                          ...
                          <div className="flex items-start gap-3 flex-wrap">
                            ...
                            <span className="text-slate-400 text-sm mt-0.5">— {ep.desc}</span>
      ...
      <section className="py-16 px-4 bg-slate-900/40">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-slate-400 text-center mb-12 max-w-xl mx-auto">Copy-paste ready. Replace <code className="text-cyan-400">cspm_your_key_here</code> with your API key from Admin → API Keys.</p>
