...
const endpointGroups = [
  ...
  },
  {
    ...
    border: "border-violet-500/20",
    endpoints: [
      { method: "GET", path: "/api/ext/skills", desc: "Get all Foreman AI skill definitions", detail: "?format=anthropic (default) | ?format=openai | ?format=openapi &mdash; Returns 100+ skills across 11 categories, including domain-aware tools like Setup Lighting Package (room-by-room fixture intelligence), Bid Comparison, Profitability Reports, and Image Vision. Auto-syncs as new skills ship. Pro+ only." },
    ],
  },
];
...
const integrations = [
  { emoji: "ðŸª–", title: "Built for AI Agents", desc: "Foreman AI uses this API internally with 100+ skills. Any AI agent - LangChain, AutoGen, Claude, GPT-4o - can connect via Bearer token." },
...
export default function ApiDocsPage() {
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-cyan-500/30 bg-cyan-500/10 text-cyan-400 text-xs font-semibold mb-6">
            ...
            PRO+ PLAN &mdash; 60+ ENDPOINTS (GROWING)
          </div>
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            60+ REST endpoints and growing rapidly — covering every major entity. Vendors, bids, homes, tasks, POs, payments, options, parts, timesheets, webhooks, and more. New endpoints ship as the platform grows. Standard auth. JSON in, JSON out.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
            ...
            <a href="https://app.cornerstonepm.ai/skills" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-4 rounded-xl bg-slate-900/60 border border-violet-500/20 hover:border-violet-500/50 transition-all duration-200 text-left group">
              ...
              <div>
                ...
                <div className="text-slate-500 text-xs">Foreman AI skill catalog (100+ skills)</div>
              </div>
            </a>
          </div>
        </div>
  ...
  -H "Content-Type: application/json"`}</pre>
      ...
      <section id="endpoints" className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-black text-center mb-4">60+ Endpoints (and growing)</h2>
      ...
      <section className="py-20 px-4 text-center border-t border-slate-800/60">
        <h2 className="text-4xl font-black mb-4">
          ...
          <span className="text-cyan-400">We have 60+ REST endpoints — and growing rapidly.</span>
        </h2>
