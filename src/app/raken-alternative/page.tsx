...
export const metadata = {
  ...
  description:
    "Raken focuses on daily logs and field reporting. Cornerstone PM is the full alternative for home builders â€” AI agents, options engine, scheduling, purchasing, and 30 webhook events from $149/mo.",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Built for home builders", cornerstone: true, competitor: false, note: "Raken targets commercial and residential GCs primarily for field documentation. Cornerstone is purpose-built for home builders." },
  { feature: "Structural options engine", cornerstone: true, competitor: false, note: "Pre-sale floorplan options pricing matrix â€” not a daily log feature." },
  ...
  { feature: "Designer Packages (64 curated by an interior designer, 7 categories)", cornerstone: true, competitor: false, note: "Buyer design center with packages curated by an actual interior designer â€” the same playbook K. Hovnanian Homes uses." },
  { feature: "Native AI agents (Foreman AI â€” 45+ skills)", cornerstone: true, competitor: false, note: "Foreman AI reads AND writes data. Blueprint AI: PDF to takeoff in 60 seconds. Raken has no native AI agents." },
  ...
  { feature: "30+ named webhook events (catalog growing)", cornerstone: true, competitor: false, note: "30+ named events and counting â€” HMAC signatures, auto-retry. New events ship as the platform grows. Raken has no webhook catalog." },
  ...
  { feature: "Public REST API (59+ endpoints, growing)", cornerstone: true, competitor: false, note: "Cornerstone Pro+: 59+ endpoints and growing rapidly, public docs. New endpoints ship as the platform grows. Raken has limited API access." },
  ...
  { feature: "Vendor portal (no login required)", cornerstone: true, competitor: false, note: "Vendors submit bids via email link â€” no account needed." },
  ...
  { feature: "Starting price", cornerstone: "$149/mo", competitor: "$20/mo+", note: "Raken is cheaper as a field log tool. Cornerstone is a full home builder platform." },
];
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "AI built in â€” 45+ skills", desc: "Foreman AI reads AND writes your data: POs, options, SOWs, bid comparisons, image search, web scraping. Blueprint AI converts floor plans to takeoffs in 60 seconds. No other home builder platform comes close." },
  { title: "30+ webhooks + public API", desc: "30+ named webhook events with typed payload schemas and HMAC signatures (catalog growing). Public REST API with 59+ endpoints and growing rapidly. Wire SMS, voice, or your own AI agent to schedule changes, vendor notifications, and bid events." },
];

const faqItems: FAQItem[] = [
  {
    q: "How is Cornerstone PM different from Raken?",
    a: "Raken is primarily a field reporting and daily log tool â€” it's great at capturing jobsite activity, time tracking, and superintendent notes. Cornerstone PM is a full construction management platform for home builders: scheduling, purchasing, bid management, homeowner portal, structural options engine, design center, multi-community pipelines, and native AI agents. If you need daily logs only, Raken is fine. If you need to run the whole build, use Cornerstone.",
  },
  {
    q: "What's the best Raken alternative for home builders?",
    a: "Cornerstone PM provides the project management backbone Raken doesn't offer. It includes scheduling (Gantt with dependencies, cascade scheduling), purchasing and POs, bid management with vendor portal, homeowner portal, structural options engine, native AI agents (Foreman AI 45+ skills, Blueprint AI), 30 webhook events, and a public REST API â€” built specifically for home builders.",
  },
  {
...
export default function RakenAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      badgeLabel="Raken Alternative â€” Production Builders"
      heroLine1="Daily logs are just the start."
      heroLine2="Manage the whole build."
      accentColor="amber"
      heroParagraph="Raken is a field reporting and daily log tool. Cornerstone PM is the full Raken alternative for home builders — scheduling, purchasing, bid management, options engine, 45+ AI skills, and a public REST API from $149/mo."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="Raken vs Cornerstone PM â€” field log tool vs. full production builder platform."
