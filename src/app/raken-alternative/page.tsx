...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Native AI agents (Foreman AI -- 117+ skills)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): Foreman AI reads AND writes construction data. Blueprint AI: PDF to takeoff in 60 seconds. Raken has no native AI agents." },
...
export default function RakenAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="amber"
      heroParagraph="Raken is a field reporting and daily log tool. Cornerstone PM™ is the full Raken alternative for home builders -- scheduling from $149/mo, options engine (Builder $299/mo), 117+ AI skills (Pro $499/mo), and a public REST API (Pro+)."
