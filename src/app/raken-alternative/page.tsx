...
export const metadata = {
  ...
  description:
    "Raken focuses on daily logs and field reporting. Cornerstone PMÃ¢â€žÂ¢ is the full alternative for home builders -- AI agents (Pro $499/mo), options engine, scheduling, purchasing, and 30+ webhook events from $149/mo.",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Native AI agents (Foreman AI -- 99+ skills)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): Foreman AI reads AND writes construction data. Blueprint AI: PDF to takeoff in 60 seconds. Raken has no native AI agents." },
...
export default function RakenAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="amber"
      heroParagraph="Raken is a field reporting and daily log tool. Cornerstone PMÃ¢â€žÂ¢ is the full Raken alternative for home builders -- scheduling from $149/mo, options engine (Builder $299/mo), 99+ AI skills (Pro $499/mo), and a public REST API (Pro+)."
