...
export const metadata = {
  title: "Raken Alternative for Home Builders | Cornerstone PMÃ¢â€žÂ¢",
  description:
    "Raken focuses on daily logs and field reporting. Cornerstone PMÃ¢â€žÂ¢ is the full alternative for home builders -- AI agents (Pro $499/mo), options engine, scheduling, purchasing, and 37+ webhook events from $149/mo.",
  alternates: { canonical: "https://www.cornerstonepm.ai/raken-alternative" },
};

const comparisonRows: ComparisonRow[] = [
  { feature: "Full construction PM platform", cornerstone: true, competitor: false, note: "Raken is primarily a daily log, field reporting, and time-tracking tool. Cornerstone PMÃ¢â€žÂ¢ is a full home-builder platform: scheduling, purchasing, bid management, homeowner portal, options engine, and more." },
  ...
  { feature: "Native AI agents (Foreman AI -- 396+ skills)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): Foreman AI reads AND writes construction data. Blueprint AI: PDF to takeoff in 60 seconds. Raken has no native AI agents." },
  ...
  { feature: "Public REST API (150+ API endpoints)", cornerstone: true, competitor: false, note: "Cornerstone Pro+: 150+ API endpoints, public docs. New endpoints ship as the platform grows. Raken has limited API access." },
...
const whySwitchCards: WhySwitchCard[] = [
  { title: "Beyond field logs: full PM platform", desc: "Raken is excellent for daily logs and field reporting. Cornerstone PMÃ¢â€žÂ¢ includes all of that plus scheduling (Starter $149), homeowner portal, purchasing, bid management, options engine, and design center (Builder $299). One platform for the entire build." },
  ...
  { title: "37+ webhooks + public API (Pro+)", desc: "37+ named webhook events with typed payload schemas and HMAC signatures. Public REST API with 150+ API endpoints -- both on Pro+ ($599/mo). Wire SMS, voice, or your own AI agent to schedule changes, vendor notifications, and bid events." },
];

const faqItems: FAQItem[] = [
  {
    q: "How is Cornerstone PMÃ¢â€žÂ¢ different from Raken?",
    a: "Raken is primarily a field reporting and daily log tool -- it's great at capturing jobsite activity, time tracking, and superintendent notes. Cornerstone PMÃ¢â€žÂ¢ is a full construction management platform for home builders: scheduling, purchasing, bid management, homeowner portal, structural options engine (Builder $299/mo), design center, multi-community pipelines, and native AI agents (Foreman AI on Pro $499/mo). If you need daily logs only, Raken is fine. If you need to run the whole build, use Cornerstone.",
  },
  {
    q: "What's the best Raken alternative for home builders?",
    a: "Cornerstone PMÃ¢â€žÂ¢ provides the project management backbone Raken doesn't offer. It includes scheduling (Gantt with dependencies, cascade scheduling from Starter $149/mo), purchasing and POs, bid management with vendor portal, homeowner portal, structural options engine (Builder $299/mo), native AI agents (Foreman AI 396+ skills on Pro $499/mo, Blueprint AI), 37+ named webhook events (Pro+), and a public REST API -- built specifically for home builders.",
  },
  {
    q: "Can I migrate from Raken to Cornerstone PMÃ¢â€žÂ¢?",
...
export default function RakenAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="amber"
      heroParagraph="Raken is a field reporting and daily log tool. Cornerstone PMÃ¢â€žÂ¢ is the full Raken alternative for home builders -- scheduling from $149/mo, options engine (Builder $299/mo), 396+ AI skills (Pro $499/mo), and a public REST API (Pro+)."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="Raken vs Cornerstone PMÃ¢â€žÂ¢ -- field log tool vs. full home-builder platform."
