...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Land management module", cornerstone: false, competitor: true, note: "NX tracks land acquisition, multi-phase community planning, and land development from acquisition through accounting. Cornerstone doesn't ship a dedicated land-dev module today; we focus on home build workflow from contract to warranty. Constellation also sells LandDev as a separate product for land-heavy operations." },
  ...
  { feature: "Public REST API (40+ endpoints, growing)", cornerstone: true, competitor: "Limited public docs", note: "Cornerstone Pro+: 40+ public REST endpoints with public docs, growing rapidly. NX advertises 'modern APIs' for integration but no public endpoint catalog — most integrations go through Constellation services." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Public API + 37+ webhooks on Pro+", desc: "40+ REST endpoints (growing), 37+ named webhook events (catalog growing), HMAC signatures, public docs. Wire Twilio, Bland, Retell, or your own agents to our webhooks. NX integrations are enterprise services engagements." },
];
