...
export const metadata = {
  title: "MarkSystems Alternative for Small-to-Mid Home Builders | Cornerstone PMÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢",
  description:
    "MarkSystems / NX alternative for home builders. Same core scope ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â sales, options, purchasing, scheduling, vendor portal ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â plus native AI agents (Foreman AI on Pro). From $149/mo, no Constellation implementation cycle, no consultant on retainer.",
  alternates: { canonical: "https://www.cornerstonepm.ai/marksystems-alternative" },
};

const comparisonRows: ComparisonRow[] = [
  { feature: "Public, transparent pricing", cornerstone: "$149 / $299 / $499 / $599 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â listed", competitor: "Hidden ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â consult-only", note: "Cornerstone publishes every tier on the website. MarkSystems / NX requires a Constellation sales consultation to learn what it costs. Hidden pricing is itself a feature gap when you're trying to evaluate options." },
  { feature: "Sign up today (no sales call required)", cornerstone: true, competitor: false, note: "Cornerstone is self-serve ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â pick a plan, sign up, you're in tonight. Constellation gates access behind 'Request a Demo' + a 1-888 sales line." },
  { feature: "Implementation cost", cornerstone: "$0", competitor: "Enterprise implementation engagement", note: "MarkSystems / NX is sold with 'dedicated support from implementation to daily use' ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â that's a paid services engagement on top of license fees. Cornerstone has zero implementation cost on every tier." },
  ...
  { feature: "37+ named webhook events (catalog growing)", cornerstone: true, competitor: "Limited", note: "Cornerstone Pro+ ($599/mo): 37+ named events and counting ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â typed payloads, HMAC signatures, delivery logs, auto-retry. NX advertises 'modern APIs' but no public webhook catalog." },
  ...
  { feature: "Built-in accounting / GL", cornerstone: "Integrate via API (QuickBooks, etc.)", competitor: true, note: "NX ships full ERP-grade accounting ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â GL, AP/AR, retainage, audit trails, financial reporting. That's a legitimate strength for 300+ homes/yr builders who want operations and accounting on one stack. Cornerstone is built for the 5ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ200 homes/yr builder who already runs QuickBooks or similar ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â we integrate with your existing accounting via our public REST API instead." },
  { feature: "Land development scheduling & tracking", cornerstone: true, competitor: true, note: "Both platforms handle land development scheduling ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â clearing, grading, utilities, paving ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â and multi-phase community tracking once you own the dirt. Cornerstone builds it into the same scheduling engine that runs the rest of the build." },
  ...
  { feature: "Property management module (rentals)", cornerstone: false, competitor: true, note: "NX includes property management ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â applications, move-ins, rent billing, regulatory compliance. Useful if you operate rentals. Cornerstone is purely home build PM, not property management." },
  ...
  { feature: "Public REST API (150+ API endpoints)", cornerstone: true, competitor: "Limited public docs", note: "Cornerstone Pro+: 150+ REST API endpoints with public docs. NX advertises 'modern APIs' for integration but no public endpoint catalog ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â most integrations go through Constellation services." },
  ...
  { feature: "Per-user fees", cornerstone: "Up to 30 users (60 on Pro+), every tier", competitor: "Enterprise contract", note: "Cornerstone: flat tier pricing, no per-seat scaling, up to 30 users (60 on Pro+). NX user licensing is enterprise-contract ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â typically per-user / per-module / per-community." },
  ...
  { feature: "Pricing model", cornerstone: "Flat ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â published online", competitor: "Enterprise quote + implementation + per-module licensing", note: "NX: enterprise contract, consult-led pricing, paid implementation, separate licenses for products like LandDev, Homeowner Central, BuilderMetrix, and Stella AI. Cornerstone: flat monthly, every feature included at the tier, self-serve onboarding." },
...
const whySwitchCards: WhySwitchCard[] = [
  { title: "NX scope. Builder pricing.", desc: "Constellation NX (the modern successor to MarkSystems) is built for top-100 production builders with implementation budgets, services contracts, and a Constellation consultant on retainer. Cornerstone delivers the same core homebuilder capabilities ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â options engine, sales pipeline, purchasing, vendor portal, scheduling ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â for the 5ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ200 homes/yr builder. Flat published pricing, self-serve onboarding, no implementation engagement." },
  { title: "AI native, not AI bolted on", desc: "Constellation sells Stella AI as a separate product on top of NX. Cornerstone bakes Foreman AI (396+ skills) and Blueprint AI directly into Pro ($499/mo) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â same monthly fee, no add-on contract, no separate implementation. AI is the platform, not an upsell." },
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PMÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢ is the closest functional MarkSystems / NX alternative for small-to-mid home builders. It includes the same core homebuilder capabilities ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â options rules engine, sales pipeline with contract management, purchasing & POs, multi-community management, construction scheduling, vendor collaboration, and warranty ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â without Constellation's enterprise quote, services engagement, or per-module licensing. Cornerstone adds native AI agents (Foreman AI 396+ skills on Pro $499/mo, Blueprint AI), 37+ named webhook events (Pro+), and a public REST API (Pro+). Pricing is published online starting at $149/mo.",
  },
  {
    q: "Is Cornerstone PMÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢ a MarkSystems / NX replacement?",
    a: "For builders running 5ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ200 homes/yr, yes. Cornerstone covers MarkSystems and NX's core homebuilder workflows in a modern AI-native platform. For enterprise builders running 300+ homes/yr who need an in-platform general ledger, property management for rental portfolios, or a full land acquisition module, NX's ERP scope and Constellation's product family (LandDev, BuilderMetrix, Homeowner Central) may be the right fit. We're honest about the segmentation.",
  },
  {
    q: "How much does Cornerstone PMÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢ cost compared to MarkSystems / NX?",
    a: "Cornerstone PMÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢ starts at $149/mo (Starter, up to 30 users) with zero implementation cost. NX and MarkSystems pricing is not publicly listed ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Constellation requires a consultation to get a quote, and implementation is sold as a separate services engagement. For the full Cornerstone platform: Builder ($299/mo, options engine + full pipeline) and Pro ($499/mo, Foreman AI + Blueprint AI) are flat within tier (up to 30 users / 60 on Pro+). Pro+ at $599/mo includes the REST API, 37+ named webhook events, and BYOA.",
  },
  {
    q: "Does Cornerstone have an AI agent like Stella AI?",
    a: "Yes ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Foreman AI, and arguably more capable. Foreman ships 396+ construction-specific skills across 20 categories that read AND write data, has per-user memory, AI vision for screenshots and photos, anti-bot web scraping for supplier pages, and runs as part of Cornerstone Pro ($499/mo) rather than as a separate product. Stella AI is sold separately on top of NX. Different distribution model.",
  },
  {
    q: "What about NX's built-in accounting? Does Cornerstone match it?",
    a: "Honestly: no, and we don't try to. NX ships ERP-grade accounting with full GL, AP/AR, retainage, audit trails, and financial reporting. That's a real fit for 300+ homes/yr builders. Cornerstone is built for the 5ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ200 homes/yr builder who already runs QuickBooks or a similar accounting system ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â we integrate with your existing accounting via our public REST API (Pro+) rather than replace it.",
  },
  {
    q: "Can I migrate from MarkSystems / NEWSTAR / NX to Cornerstone?",
    a: "Yes. The AI Migration Wizard handles MarkSystems, NEWSTAR, NX, BuildPro, Hyphen HomeFront, BRIX, KOVA, Buildertrend, CoConstruct, JobTread, and any CSV/Excel export. Drop your files in, AI auto-detects column mapping, runs 23 dedicated import endpoints covering vendors, homes, communities, scopes, takeoffs, parts catalog, budgets, design categories, floorplans, warranties, and more. ~$0.01 per migration ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â we absorb it. White-glove migration available on Pro and Pro+ plans.",
  },
  {
...
export default function MarkSystemsAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="emerald"
      heroParagraph="Cornerstone PMÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢ is the modern, AI-native alternative to Constellation HomeBuilder Systems' MarkSystems and its successor NX, built for small-to-mid home builders. Same core scope ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â options rules engine, sales pipeline, purchasing, scheduling, vendor portal, warranty ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â plus native AI agents (Foreman AI on Pro $499/mo), 37+ named webhook events (Pro+), and a public REST API (Pro+ $599/mo). Pricing published online from $149/mo. No Constellation services engagement required."
      ...
      migrationDesc="Export your MarkSystems / NX data, drag the files into our wizard, and AI auto-maps every column across vendors, homes, communities, design options, scopes, and budgets. Dry-run before you commit. ~$0.01 per migration ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â we absorb it. No Constellation services engagement required."
      faqTitle="MarkSystems Alternative FAQ"
      faqSubtitle="Common questions about switching to Cornerstone PMÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢ from MarkSystems, NX, or NEWSTAR."
      faqItems={faqItems}
