...
export default async function AdminAnalyticsPage() {
  ...
  const ga4Url =
    "https://analytics.google.com/analytics/web/#/a395613947p538783545/reports/explorer?params=_u..nav%3Dmaui&r=all-pages&ruid=all-pages,life-cycle,acquisition,acquisition-traffic";
