...
export const metadata = {
  title: "Buildertrend Alternative for Home Builders | Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢",
  description:
    "Buildertrend alternative built for home builders. Native AI agents (Pro $499/mo), options engine, REST API, and multi-community management - flat pricing from $149/mo, up to 30 users (60 on Pro+).",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Native AI agents (Foreman AI + Blueprint AI)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): 396+ Foreman AI skills that read AND write data, plus Blueprint AI floor plan takeoffs in 60 sec. Buildertrend has no native action-taking AI agents." },
  ...
  { feature: "Public REST API (150+ API endpoints)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 150+ API endpoints, public docs. New endpoints ship as the platform grows. Buildertrend: enterprise API access, not self-serve." },
  ...
  { feature: "Homeowner portal (realtime sync + photos + messaging + ZIP export)", cornerstone: true, competitor: "limited", note: "Cornerstone gives buyers a real-time portal synced with construction scheduling ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â when framing moves three days, they see it instantly, no follow-up call needed. Plus: (1) builder/PM uploads job-site photos to every milestone (up to 5 photos per milestone via a camera button on the task row), (2) built-in messaging app between builder and customer with a permanent searchable record of every conversation, and (3) one-click ZIP download of all job photos so buyers can save their whole build history. Buildertrend has a client portal with messaging, but the milestone-photo workflow and bulk ZIP export aren't packaged the same way." },
  { feature: "Bid management + vendor portal", cornerstone: true, competitor: true, note: "Cornerstone Pro+ adds the 7-wave automated bidding pipeline + a no-login vendor portal: vendors confirm tasks, accept schedule changes, and submit bids via secure email magic links ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no app, no account, no password." },
  ...
  { feature: "User caps (30 Starter/Builder/Pro Ãƒâ€šÃ‚Â· 60 Pro+)", cornerstone: true, competitor: true, note: "Both include generous user caps. Cornerstone: every tier from $149. Buildertrend: custom pricing - contact for quote." },
  { feature: "Pricing model", cornerstone: "Flat ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â up to 30 users (60 on Pro+)", competitor: "Custom quote", note: "Buildertrend no longer publishes pricing -- custom quotes only. Cornerstone is flat at every tier ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â up to 30 users (60 on Pro+). More importantly: Buildertrend doesn't ship a structural options engine, floorplan pricing matrix, multi-community pipelines, native AI agents, or 37+ named webhook events at any price point." },
  { feature: "Cornerstone tiers (flat ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â up to 30 users ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ 60 on Pro+)", cornerstone: "$149 / $299 / $499 / $599", competitor: "--", note: "Starter ($149): scheduling, permits, homeowner portal. Builder ($299): adds sales pipeline, purchasing, design center with options engine and designer packages. Pro ($499): adds Foreman AI + Blueprint AI. Pro+ ($599): adds REST API, BYOA, 37+ named webhook events, 7-wave bidding." },
];
...
const faqItems: FAQItem[] = [
  {
    ...
    a: "For home builders - production, semi-custom, and custom - Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ is a strong Buildertrend alternative with key advantages: native AI agents (Foreman AI 396+ skills on Pro $499/mo, Blueprint AI), an options engine (Builder $299/mo), floorplan pricing matrix, multi-community management, 37+ named webhook events (Pro+), and a public REST API (Pro+). Buildertrend was built for custom builders and remodelers doing one-off jobs; Cornerstone is built for builders who repeat floorplans, run multi-community pipelines, and want AI that takes real actions.",
  },
  {
    q: "How is Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ different from Buildertrend?",
  ...
  {
    q: "Is Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ cheaper than Buildertrend?",
    a: "Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢'s tiers start at $149/mo (Starter, up to 30 users). Buildertrend no longer publishes pricing - they use custom quotes. For an apples-to-apples platform comparison: Cornerstone Builder ($299/mo, options engine + full pipeline) and Cornerstone Pro ($499/mo, Foreman AI + Blueprint AI) are flat within tier (up to 30 users / 60 on Pro+). The full Cornerstone Pro+ plan at $599/mo includes capabilities Buildertrend doesn't offer at any price.",
  },
  {
    q: "Can I migrate from Buildertrend to Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢?",
  ...
  {
    q: "What are the 37+ webhook events?",
    a: "Cornerstone's 37+ named webhook events (Pro+) cover: home lifecycle (created, status changed, closed), task/schedule updates, vendor notifications, cascade scheduling triggers, message events, sales pipeline changes, and bid request events. Every event ships with a typed payload schema, HMAC signature verification, delivery logs, and auto-retry. Buildertrend's webhooks are limited and have no public event catalog.",
  },
];
...
export default function BuildertrendAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="cyan"
      heroParagraph="Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ is the Buildertrend alternative for home builders who repeat floorplans, run multi-community pipelines, and want AI that takes real actions. Native Foreman AI (396+ skills, Pro $499/mo), options engine, floorplan pricing matrix, 37+ named webhook events (Pro+), and a public REST API - flat pricing from $149/mo, up to 30 users (60 on Pro+)."
      ...
      faqSubtitle="Common questions about switching to Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ from Buildertrend."
      faqItems={faqItems}
