...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Native AI agents (Foreman AI + Blueprint AI)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): 117+ Foreman AI skills that read AND write data, plus Blueprint AI floor plan takeoffs in 60 sec. Buildertrend has no native action-taking AI agents." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Action-taking AI on Pro - 117+ skills", desc: "Foreman AI (Cornerstone Pro, $499/mo) reads AND writes data, remembers your preferences, analyzes jobsite photos, and scrapes product pages from Home Depot and Ferguson using AI-powered web scraping. No bolt-on plugins." },
...
export default function BuildertrendAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="cyan"
      heroParagraph="Cornerstone PM™ is the Buildertrend alternative for home builders who repeat floorplans, run multi-community pipelines, and want AI that takes real actions. Native Foreman AI (117+ skills, Pro $499/mo), options engine, floorplan pricing matrix, 37+ named webhook events (Pro+), and a public REST API - flat pricing from $149/mo, up to 30 users (60 on Pro+)."
