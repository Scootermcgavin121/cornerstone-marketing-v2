...
const comparisonRows = [
  ...
  { feature: "Native AI agents (47 skills)", cornerstone: true, buildertrend: false, note: "Buildertrend has no native AI agents." },
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "The REST API (59 endpoints, 14 webhook events, scoped Bearer-token auth, public docs) is included on the Pro+ plan at $599/mo. BYOA &mdash; bringing your own Claude or ChatGPT agent against live builder data &mdash; is also included on Pro+.",
  },
];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { title: "REST API + BYOA", desc: "59 endpoints, 14 webhook events, scoped auth, public docs. Bring your own Claude or ChatGPT agent against your live data." },
            ].map((card) => (
