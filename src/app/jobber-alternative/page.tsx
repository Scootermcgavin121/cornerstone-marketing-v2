...
export const metadata = {
  ...
  description:
    "Jobber is built for home service businesses. Cornerstone PM is the alternative for production new home builders â€” AI agents, options engine, and multi-community management from $149/mo.",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Structural options engine", cornerstone: true, competitor: false, note: "Pre-sale floorplan options pricing matrix â€” not a home service concept." },
  ...
  { feature: "Native AI agents (Foreman AI â€” 45+ skills)", cornerstone: true, competitor: false, note: "Foreman AI reads AND writes data. Blueprint AI: PDF to takeoff in 60 seconds. Jobber has no native AI agents." },
  ...
  { feature: "Public REST API (59+ endpoints, growing)", cornerstone: true, competitor: true, note: "Both offer public APIs. Cornerstone: 59+ endpoints and growing rapidly. Jobber's API is oriented toward service industry workflows." },
  ...
  { feature: "Starting price", cornerstone: "$149/mo", competitor: "$49/mo+", note: "Jobber is cheaper but built for service businesses. Cornerstone is a full home builder platform." },
];
...
export default function JobberAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      badgeLabel="Jobber Alternative â€” Home Builders"
      heroLine1="Jobber is for home services."
      heroLine2="You build homes."
      accentColor="amber"
      heroParagraph="Jobber is a field service platform for landscapers, cleaners, and HVAC companies. Cornerstone PM is the alternative for production new home builders â€” structural options engine, floorplan pricing, 45+ AI skills, and multi-community management from $149/mo."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="Jobber vs Cornerstone PM â€” home services platform vs. home builder platform."
      comparisonRows={comparisonRows}
      trademarkName="Jobber"
      whySwitchHeadline="What home builders get that Jobber can't offer"
      whySwitchCards={whySwitchCards}
      honestAngle="If you're a home service business â€” landscaping, cleaning, pest control, HVAC â€” Jobber is probably fine. This page is for home builders who found Jobber through a general search. You need different software, and Cornerstone PM is built for your workflows."
