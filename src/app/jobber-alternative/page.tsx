...
export const metadata = {
  title: "Jobber Alternative for Home Builders | Cornerstone PMâ„¢",
  description:
    "Jobber is built for home service businesses. Cornerstone PMâ„¢ is the alternative for home builders -- AI agents (Pro $499/mo), options engine, and multi-community management from $149/mo.",
  alternates: { canonical: "https://www.cornerstonepm.ai/jobber-alternative" },
};

const comparisonRows: ComparisonRow[] = [
  { feature: "Built for home builders", cornerstone: true, competitor: false, note: "Jobber is built for home service businesses (landscaping, cleaning, HVAC, etc.). Cornerstone PMâ„¢ is purpose-built for home builders -- production, semi-custom, and custom -- with lot management, options engine, and multi-community pipelines." },
  ...
  { feature: "Native AI agents (Foreman AI -- 396+ skills)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): Foreman AI reads AND writes construction data. Blueprint AI: PDF to takeoff in 60 seconds. Jobber has no native AI agents." },
  ...
  { feature: "37+ named webhook events (catalog growing)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+ ($599/mo): 37+ named events and counting -- typed payloads, HMAC signatures, delivery logs, auto-retry. New events ship as the platform grows. Jobber: limited webhook support for home service workflows." },
  ...
  { feature: "Public REST API", cornerstone: true, competitor: true, note: "Both offer public APIs. Jobber's API is oriented toward service industry workflows. Cornerstone Pro+: 150+ API endpoints, purpose-built for construction management." },
  ...
  { feature: "Pricing model", cornerstone: "Flat â€” up to 30 users (60 on Pro+)", competitor: "Per-user tiers", note: "Jobber is priced per user with tiered plans. Cornerstone is flat at every tier â€” up to 30 users (60 on Pro+). More importantly: Jobber doesn't ship an options engine, floorplan pricing matrix, multi-community pipelines, or home-builder AI at any price." },
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PMâ„¢ is purpose-built for home builders. It covers the same basics (scheduling, client portal, quotes, document management) plus a structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community lot management, native AI agents (Foreman AI 396+ skills on Pro $499/mo, Blueprint AI), 37+ named webhook events (Pro+), and a public REST API -- all the home-builder features Jobber doesn't have.",
  },
  {
    q: "Can I migrate from Jobber to Cornerstone PMâ„¢?",
...
export default function JobberAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="amber"
      heroParagraph="Jobber is a field service platform for landscapers, cleaners, and HVAC companies. Cornerstone PMâ„¢ is the alternative for home builders -- structural options engine (Builder $299/mo), floorplan pricing, 396+ AI skills (Pro $499/mo), and multi-community management from $149/mo."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="Jobber vs Cornerstone PMâ„¢ -- home services platform vs. home-builder platform."
      comparisonRows={comparisonRows}
      trademarkName="Jobber"
      whySwitchHeadline="What home builders get that Jobber can't offer"
      whySwitchCards={whySwitchCards}
      honestAngle="If you're a home service business -- landscaping, cleaning, pest control, HVAC -- Jobber is probably fine. This page is for home builders who found Jobber through a general search. You need different software, and Cornerstone PMâ„¢ is built for your workflows."
