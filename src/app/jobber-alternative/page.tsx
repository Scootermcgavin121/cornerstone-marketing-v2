...
export const metadata = {
  title: "Jobber Alternative for Home Builders | Cornerstone PMÃ¢â€žÂ¢",
  description:
    "Jobber is built for home service businesses. Cornerstone PMÃ¢â€žÂ¢ is the alternative for home builders -- AI agents (Pro $499/mo), options engine, and multi-community management from $149/mo.",
  alternates: { canonical: "https://www.cornerstonepm.ai/jobber-alternative" },
};

const comparisonRows: ComparisonRow[] = [
  { feature: "Built for home builders", cornerstone: true, competitor: false, note: "Jobber is built for home service businesses (landscaping, cleaning, HVAC, etc.). Cornerstone PMÃ¢â€žÂ¢ is purpose-built for home builders -- production, semi-custom, and custom -- with lot management, options engine, and multi-community pipelines." },
...
export default function JobberAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      honestAngle="If you're a home service business -- landscaping, cleaning, pest control, HVAC -- Jobber is probably fine. This page is for home builders who found Jobber through a general search. You need different software, and Cornerstone PMÃ¢â€žÂ¢ is built for your workflows."
