...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PM™ is purpose-built for home builders. It covers the same basics (scheduling, client portal, quotes, document management) plus a structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community lot management, native AI agents (Foreman AI 396+ skills on Pro $499/mo, Blueprint AI), 37+ named webhook events (Pro+), and a public REST API -- all the home-builder features Jobber doesn't have.",
  },
  {
...
export default function JobberAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="amber"
      heroParagraph="Jobber is a field service platform for landscapers, cleaners, and HVAC companies. Cornerstone PM™ is the alternative for home builders -- structural options engine (Builder $299/mo), floorplan pricing, 396+ AI skills (Pro $499/mo), and multi-community management from $149/mo."
