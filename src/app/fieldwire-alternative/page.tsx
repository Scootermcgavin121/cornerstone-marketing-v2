...
export const metadata = {
  ...
  description:
    "Fieldwire is a commercial construction field management tool. Cornerstone PMÃ¢â€žÂ¢ is the alternative for residential home builders -- AI agents (Pro $499/mo), options engine, scheduling, and 37+ webhook events from $149/mo.",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Pricing model", cornerstone: "Flat Ã¢â‚¬â€ up to 30 users (60 on Pro+)", competitor: "Per user / month", note: "Fieldwire: $0 (Basic, up to 5 users/3 projects), $39/user/mo (Pro annual), $64/user/mo (Business), $89/user/mo (Business Plus). Cornerstone: flat at every tier Ã¢â‚¬â€ up to 30 users (60 on Pro+) from $149. More importantly: Fieldwire doesn't ship a residential options engine, buyer design center, multi-community pipelines, or action-taking AI at any tier." },
...
export default function FieldwireAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="rose"
      heroParagraph="Fieldwire is a commercial construction field management and plan room tool. Cornerstone PMÃ¢â€žÂ¢ is the Fieldwire alternative for residential home builders -- structural options engine (Builder $299/mo), floorplan pricing, 396+ AI skills (Pro $499/mo), and multi-community management from $149/mo."
