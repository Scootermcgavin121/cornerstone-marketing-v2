...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Public REST API (150+ API endpoints)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 150+ API endpoints, public docs. New endpoints ship as the platform grows. Fieldwire: API access on Business Plus or custom contract only." },
  ...
  { feature: "Punch lists", cornerstone: true, competitor: true, note: "Both ship punch lists -- but they're built for different closeouts. Cornerstone: items carry severity, room, trade, up to 5 photos, vendor assignment, and an OPEN to IN PROGRESS to RESOLVED lifecycle, and Punchlist AI builds the whole list for you from a walkthrough video or a home inspector's PDF -- it reads every finding, pulls the inspector's own embedded photos onto the matching item, tags severity/room/trade, and auto-assigns each item to the right vendor, then groups every item for a vendor into one email. Fieldwire's punch tools are purpose-built for commercial GC closeout -- pinned to a drawing sheet, with offline sync and a native field app. Cornerstone does not pin punch items to plan coordinates and has no offline mode." },
  { feature: "AI punch list from walkthrough video or inspection PDF", cornerstone: true, competitor: false, note: "Industry first. Record a walk-through on your phone talking through what you see, or upload a 40-60 page home inspection report -- either way you get a sorted, severity-tagged, photo-attached, vendor-assigned punch list in about a minute. Included on every tier, starting at Starter $149/mo. Fieldwire has no equivalent -- every punch item is typed in by hand." },
  { feature: "Offline field mode / native mobile app", cornerstone: false, competitor: true, note: "Fieldwire ships native iOS and Android apps with offline sync -- a real advantage for superintendents on jobsites with no signal. Cornerstone is responsive web: it works on a phone browser (including camera capture for punch photos and walkthrough video), but it requires a connection." },
...
export default function FieldwireAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="rose"
      heroParagraph="Fieldwire is a commercial construction field management and plan room tool. Cornerstone PM™ is the Fieldwire alternative for residential home builders -- structural options engine (Builder $299/mo), floorplan pricing, 396+ AI skills (Pro $499/mo), and multi-community management from $149/mo."
