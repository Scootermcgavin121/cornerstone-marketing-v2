...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Public REST API (40+ endpoints, growing)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 40+ endpoints and growing rapidly, public docs. New endpoints ship as the platform grows. Fieldwire: API access on Business Plus or custom contract only." },
...
export default function FieldwireAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="rose"
      heroParagraph="Fieldwire is a commercial construction field management and plan room tool. Cornerstone PM™ is the Fieldwire alternative for residential home builders -- structural options engine (Builder $299/mo), floorplan pricing, 100+ AI skills (Pro $499/mo), and multi-community management from $149/mo."
