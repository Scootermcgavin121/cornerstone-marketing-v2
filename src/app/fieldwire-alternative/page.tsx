...
export default function FieldwireAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="rose"
      heroParagraph="Fieldwire is a commercial construction field management and plan room tool. Cornerstone PMÃ¢â€žÂ¢ is the Fieldwire alternative for residential home builders -- structural options engine (Builder $299/mo), floorplan pricing, 100+ AI skills (Pro $499/mo), and multi-community management from $149/mo."
