...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Public REST API (500+ endpoints, growing)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 500+ endpoints and growing rapidly, public docs. New endpoints ship as the platform grows. Fieldwire: API access on Business Plus or custom contract only." },
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Fieldwire includes 'Field Intelligence AI' on their Business plan ($64/user/month) for commercial plan management -- markup analysis, submittal extraction, and plan comparison. Cornerstone's Foreman AI (Pro $499/mo) is a native agent with 100+ skills that takes real construction management actions: creates POs, updates design options, generates SOWs, runs bid comparisons, and analyzes screenshots with AI vision.",
  },
  {
