...
export const metadata = {
  title: "Hyphen Solutions Alternative for Home Builders | Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢",
  description:
...
const comparisonRows: ComparisonRow[] = [
  { feature: "Public, transparent pricing", cornerstone: "$149 / $299 / $499 / $599 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â listed", competitor: "Hidden ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â consult-only, per-product licensing", note: "Cornerstone publishes every tier on the website. Hyphen Solutions licenses each product separately (BuildPro, BRIX, BuilderGM, HomeFront, Hyphen CRM, HomeSight, Hyphen Wallet) and pricing requires a sales call. Add up enough Hyphen products and you're easily looking at thousands per month before implementation." },
  { feature: "One platform vs multi-product suite", cornerstone: true, competitor: false, note: "Hyphen Solutions sells 12+ separate products that interoperate via their hub. Cornerstone is one platform ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â sales, design center, purchasing, scheduling, vendor management, homeowner portal, warranty, AI all in a single app with one login, one bill, one data model." },
  { feature: "Sign up today (no sales call required)", cornerstone: true, competitor: false, note: "Cornerstone is self-serve ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â pick a plan, sign up, you're in tonight. Every Hyphen product requires a 'Request a Demo' sales cycle." },
  ...
  { feature: "Built-in accounting / GL", cornerstone: "Integrate via API (QuickBooks, Sage, etc.)", competitor: true, note: "BRIX, BuilderGM, and HomeFront all ship accounting with GL and AP. That's a real strength for builders who want operations and accounting on one stack. Cornerstone is built for the 5ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“200 homes/yr builder who already runs QuickBooks or Sage ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â we integrate with your existing accounting via our public REST API (Pro+) instead." },
  { feature: "Land development scheduling & tracking", cornerstone: true, competitor: true, note: "Both platforms handle land development scheduling ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â clearing, grading, utilities, paving ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â once you own the dirt. Cornerstone builds it into the same scheduling engine that runs the rest of the build." },
  ...
  { feature: "B2B supplier network (1 in 3 US homes)", cornerstone: false, competitor: true, note: "Hyphen Solutions advertises 'more than 126,720 users, 565 Builders and 18,000 residential Suppliers' across their software suite. That supplier network is a genuine asset if you're a national production builder ordering from many of those suppliers. Cornerstone is a builder-side PM platform ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â we don't run a supplier network." },
  ...
  { feature: "Vendor portal access", cornerstone: "Tokenized magic links ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â zero login", competitor: "SupplyPro login required", note: "Hyphen's SupplyPro / SupplyPro GM are full vendor portals ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â vendors maintain accounts, log in, and manage orders/payments inside Hyphen's hub. That's genuinely useful at national-builder scale. Cornerstone replaces the login with tokenized magic links ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â vendors get a secure link, click once, bid or confirm tasks. No account, no password, no app install. Adoption is dramatically higher when subs don't have to manage another login ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â better fit for the 5ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“200 homes/yr builder whose subs aren't already wired into a national supplier network." },
  { feature: "Flexible PO generation (4 patterns, mix on same job)", cornerstone: true, competitor: "Standard EPO/VPO model", note: "Cornerstone gives you four PO patterns: (1) all POs at job start, (2) partial deposit POs from earlier pipeline tasks, (3) full PO auto-generated when a task is marked complete, or (4) configurable per task / scope / community. Hyphen products use the EPO (Extra Purchase Order) / VPO (Variance Purchase Order) model ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â solid but rigid." },
  { feature: "Homeowner portal (realtime sync + photos + messaging + ZIP export)", cornerstone: true, competitor: "In BuildPro/BRIX/BuilderGM with warranty", note: "Cornerstone bundles the buyer portal into every tier ($149+) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â real-time sync with construction schedule, milestone photos, messaging, one-click ZIP export. Hyphen offers homeowner portal as part of BuildPro / BRIX / BuilderGM (varies per product) and Hyphen HomeSight handles online sales separately." },
  ...
  { feature: "Public REST API (150+ API endpoints)", cornerstone: true, competitor: "Limited public docs", note: "Cornerstone Pro+: 150+ REST API endpoints with public docs. Hyphen products integrate inside the Hyphen Hub but don't expose a public REST endpoint catalog for builder-facing automation." },
  ...
  { feature: "Take your data with you anytime ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no lock-in", cornerstone: true, competitor: false, note: "Your data is YOURS. Full database export to CSV or JSON anytime, one click, $0. Nightly auto-backups retained 7 days. Hyphen data extraction goes through their services team." },
  { feature: "Per-user fees", cornerstone: "Up to 30 users (60 on Pro+), every tier", competitor: "Per-product licensing", note: "Cornerstone: flat tier pricing, no per-seat scaling. Hyphen licenses each product (BuildPro, BRIX, BuilderGM, HomeFront, Hyphen CRM, HomeSight, Hyphen Wallet) on its own terms ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â stacking products stacks bills." },
  { feature: "Pricing model", cornerstone: "Flat ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â published online", competitor: "Per-product quote + implementation services", note: "Hyphen: enterprise contracts per product, paid Professional Implementation, paid Custom Report Writing. Cornerstone: flat monthly, every feature included at the tier, self-serve onboarding." },
...
const whySwitchCards: WhySwitchCard[] = [
  { title: "One platform, one bill", desc: "Hyphen sells a suite ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â BuildPro for construction, BRIX for ERP, BuilderGM for mid-market, HomeFront for builder ERP, Hyphen CRM for sales, HomeSight for online buyer experience, SupplyPro for suppliers, Hyphen Wallet for payments, Chameleon Power for visualization. Each is a separate product, separate license, separate implementation. Cornerstone is one platform with all of it included at the tier." },
  { title: "AI native, not a missing feature", desc: "Hyphen's product family does not ship a native AI agent. Cornerstone Pro ($499/mo) ships Foreman AI's 396+ skills and Blueprint AI's 60-second takeoffs as core platform features ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â not an add-on, not an upsell, not a roadmap promise." },
  { title: "Cloud-only, not on-premise", desc: "Hyphen HomeFront, their flagship builder ERP, is explicitly an on-premise product. BRIX is their cloud successor. Cornerstone is 100% cloud-native ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no IT department required, no servers to maintain, automatic updates, accessible from any browser or mobile device." },
];

const faqItems: FAQItem[] = [
  {
    q: "What is the best Hyphen Solutions alternative for home builders?",
    a: "Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ is the closest unified alternative to the Hyphen Solutions suite (HomeFront, BRIX, BuilderGM, BuildPro, Hyphen CRM, Hyphen HomeSight) for small-to-mid home builders. Instead of licensing five or more separate Hyphen products and paying Professional Implementation for each, Cornerstone bundles sales pipeline, design center, purchasing, scheduling, vendor management, homeowner portal, warranty, and native AI agents into one platform starting at $149/mo. Pricing is published online; no Hyphen sales call required.",
  },
  {
    q: "Is Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ a replacement for Hyphen HomeFront?",
    a: "For small-to-mid home builders, yes. Cornerstone covers HomeFront's core workflows ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â sales, contracts, options, purchasing, job costing, takeoffs, scheduling, vendor collaboration, warranty ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â in a modern cloud-native AI-native platform without on-premise installs. The one honest gap: HomeFront ships full GL accounting; Cornerstone integrates with your existing QuickBooks / Sage Intacct / Sage 300 via our public REST API on Pro+ instead of replacing it. For 5ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“200 homes/yr builders who already run an accounting system, the integration model usually wins.",
  },
  {
    q: "What about BRIX and BuilderGM?",
    a: "BRIX is Hyphen's cloud ERP with built-in accounting (their newer successor to HomeFront), and BuilderGM is the mid-market core. Cornerstone overlaps with both on the operations side ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â sales, options, purchasing, scheduling, vendor management, takeoffs, warranty. We don't ship the in-platform GL; we integrate with your accounting system instead. Trade-off: BRIX's licensing is per-product / per-implementation; Cornerstone is one flat monthly fee.",
  },
  {
  ...
  },
  {
    ...
    a: "Not natively today, no. Hyphen Wallet is Hyphen's payments product (B2B AP automation, ePayables) and SupplyPro is their supplier-side network. If you're deeply embedded in the Hyphen supplier network for ordering, those advantages are real and worth weighing. For builders whose vendor relationships are direct, Cornerstone's tokenized magic links + 37+ webhooks let you wire any payment processor or AP system you want ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â typically simpler than the multi-product Hyphen stack.",
  },
  {
    q: "How much does Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ cost compared to Hyphen Solutions?",
    a: "Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ starts at $149/mo (Starter, up to 30 users) with zero implementation cost. Hyphen Solutions pricing is not publicly listed ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â each product (BuildPro, BRIX, BuilderGM, HomeFront, Hyphen CRM, HomeSight, Hyphen Wallet) is quoted separately with Professional Implementation on top. Builders running multiple Hyphen products often end up paying significantly more than a single Cornerstone Pro+ ($599/mo) license that includes equivalent functionality.",
  },
  {
    q: "Can I migrate from Hyphen HomeFront / BRIX / BuilderGM / BuildPro to Cornerstone?",
    a: "Yes. The AI Migration Wizard handles every major Hyphen product, plus MarkSystems, NEWSTAR, NX, KOVA, Buildertrend, CoConstruct, JobTread, and any CSV/Excel export. Drop your files in, AI auto-detects column mapping, runs 23 dedicated import endpoints covering vendors, homes, communities, scopes, takeoffs, parts catalog, budgets, design categories, floorplans, warranties, and more. ~$0.01 per migration ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â we absorb it. White-glove migration available on Pro and Pro+ plans.",
  },
  {
    q: "Is there a free trial?",
    a: "Yes. The 2-year free beta is open to the first 100 home builders ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no credit card, no contract, no implementation fee.",
  },
];
...
export default function HyphenAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="amber"
      heroParagraph="Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ is the unified, AI-native alternative to the Hyphen Solutions multi-product suite (HomeFront, BRIX, BuilderGM, BuildPro, Hyphen CRM, HomeSight). Same core scope ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â sales pipeline, options engine, purchasing, scheduling, vendor portal, homeowner portal, warranty ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â plus native AI agents (Foreman AI on Pro $499/mo), 37+ named webhook events (Pro+), and a public REST API (Pro+ $599/mo). One platform, one login, one flat monthly bill from $149/mo. No Professional Implementation engagement required."
      ...
      migrationDesc="Export your HomeFront / BRIX / BuilderGM / BuildPro data, drag the files into our wizard, and AI auto-maps every column across vendors, homes, communities, design options, scopes, and budgets. Dry-run before you commit. ~$0.01 per migration ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â we absorb it. No Professional Implementation engagement required."
      faqTitle="Hyphen Solutions Alternative FAQ"
      faqSubtitle="Common questions about switching to Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ from Hyphen HomeFront, BRIX, BuilderGM, or BuildPro."
      faqItems={faqItems}
