...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "MCP server + Public REST API (150+ API endpoints)", cornerstone: true, competitor: "Limited public docs", note: "Cornerstone Pro+: built-in MCP server (connect Claude Desktop, Cursor, or Windsurf in ~30 seconds) plus 150+ REST API endpoints with public docs. Hyphen products integrate inside the Hyphen Hub but don't expose a public REST endpoint catalog or MCP server for builder-facing automation." },
