...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Land management module", cornerstone: false, competitor: true, note: "BRIX and BuildPro both ship land management. Cornerstone doesn't ship a dedicated land-dev module today; we focus on home build workflow from contract to warranty." },
