...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Public REST API (40+ endpoints, growing)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 40+ endpoints and growing rapidly, public docs. New endpoints ship as the platform grows. Knowify: limited API, QuickBooks-oriented integrations." },
...
export default function KnowifyAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="violet"
      heroParagraph="Knowify is built for specialty subcontractors billing to GCs. Cornerstone PM™ is the alternative for home builders in the GC role -- managing subs, running communities, pre-selling homes with a design center (Builder $299/mo), and closing with draws. From $149/mo with up to 30 users (60 on Pro+)."
