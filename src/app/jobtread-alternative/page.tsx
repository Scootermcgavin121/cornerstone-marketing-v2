...
export const metadata = {
  ...
  description:
    "JobTread alternative with action-taking AI agents (117+ skills), structural options engine, and 37+ named webhook events. Home-builder native. Plans from $149/mo to $599/mo flat - no per-user fees.",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "AI agents that take real actions (Cornerstone Pro / Pro+)", cornerstone: true, competitor: "limited", note: "Foreman AI (Pro+ at $499/mo) reads AND writes data - creates POs, updates options, generates SOWs, runs bid comparisons. 117+ purpose-built skills. JobTread's AI Connector lets you plug in third-party AI (ChatGPT, Claude) for chat-style assistance - it doesn't ship native action-taking agents." },
