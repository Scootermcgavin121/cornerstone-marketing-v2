...
export const metadata = {
  ...
  description:
    "JobTread alternative with action-taking AI agents (100+ skills), structural options engine, and 37+ named webhook events. Home-builder native. Plans from $149/mo to $599/mo flat - no per-user fees.",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Public REST API (500+ endpoints, growing)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 500+ endpoints and growing rapidly, public docs. New endpoints ship as the platform grows. JobTread offers Zapier and AI Connector integrations rather than a full open REST API." },
