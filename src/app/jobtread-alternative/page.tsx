...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "MCP server + Public REST API (150+ API endpoints)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: built-in MCP server (connect Claude Desktop, Cursor, or Windsurf in ~30 seconds — the no-code on-ramp) plus 150+ API endpoints with public docs. New endpoints ship as the platform grows. JobTread offers Zapier and AI Connector integrations rather than a full open REST API or an MCP server." },
