...
export const metadata = {
  ...
  description:
    "JobTread alternative with action-taking AI agents (110+ skills), structural options engine, and 37+ named webhook events. Home-builder native. Plans from $149/mo to $599/mo flat - no per-user fees.",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "AI agents that take real actions (Cornerstone Pro / Pro+)", cornerstone: true, competitor: "limited", note: "Foreman AI (Pro+ at $499/mo) reads AND writes data - creates POs, updates options, generates SOWs, runs bid comparisons. 110+ purpose-built skills. JobTread's AI Connector lets you plug in third-party AI (ChatGPT, Claude) for chat-style assistance - it doesn't ship native action-taking agents." },
  ...
  { feature: "Take your data with you anytime — no lock-in", cornerstone: true, competitor: true, note: "Both let you export your data. Cornerstone: one-click CSV/JSON export anytime, $0, no support ticket, plus nightly 7-day rolling auto-backups for instant rollback. Leave with everything — vendors, homes, schedules, options, budgets, every line. JobTread supports data export through their platform." },
  { feature: "Vendor portal — no login required (email magic links)", cornerstone: true, competitor: "limited", note: "Cornerstone: vendors click a secure magic link in their email to confirm tasks, accept schedule changes, and submit bids — no account, no app, no password. JobTread has sub/vendor portals but they're account-based, so vendors still have to sign up and remember a login." },
  ...
  { feature: "User caps (30 Starter/Builder/Pro · 60 Pro+)", cornerstone: true, competitor: false, note: "Cornerstone: every plan, every tier. JobTread: $20/user (tiered breaks above 10 users)." },
  { feature: "Pricing model", cornerstone: "Flat — up to 30 users (60 on Pro+)", competitor: "$199 + $20/user", note: "Cornerstone is flat at every tier. JobTread is $199 base plus $20 per user, so the bill grows with your crew. Different model entirely — but more importantly, these aren't priced against the same product. JobTread doesn't ship an options engine, floorplan pricing matrix, designer packages, or multi-community pipelines at any user count." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Flat pricing, no per-user math", desc: "Cornerstone Starter $149, Builder $299, Pro $499, Pro+ $599 - flat at every tier — up to 30 users (60 on Pro+). JobTread starts $199 + $20/user; a 20-person team is $599/mo. Bring on your whole crew without watching the meter." },
];
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Honest answer: they're not really priced against the same product, so per-user math is a distraction. JobTread is one flat plan at $199/mo base plus $20 per user. Cornerstone is tiered: Starter $149/mo (scheduling + portal), Builder $299/mo (adds sales pipeline, purchasing, design center with options engine and designer packages), Pro $499/mo (adds Foreman AI + Blueprint AI), Pro+ $599/mo (adds REST API, BYOA, 37+ named webhook events, 7-wave bidding). Every Cornerstone tier is flat with up to 30 users (60 on Pro+). The real difference isn't price-per-user — it's that JobTread doesn't have a structural options engine, floorplan pricing matrix, multi-community pipelines, or designer packages at any plan or any team size. If you need those, JobTread isn't an option regardless of cost.",
  },
  {
    q: "How is Foreman AI different from JobTread's AI Connector?",
    a: "They’re in different categories. JobTread's AI Connector is a bridge: it exposes ~35 mostly basic CRUD skills (list homes, create vendor, search parts) and routes the thinking back to a third-party LLM like ChatGPT or Claude. Foreman AI is a native construction agent with 110+ purpose-built skills that chain together into real workflows. One prompt can read a blueprint, learn your fixture preferences from past takeoffs, build a complete fixture-by-fixture lighting package, and tag everything with option classes for the design center — all in a single call against your live data. And because Foreman ships learnBuilderPreferences, every skill gets smarter the more floorplans you set up; JobTread's AI stays static. Foreman is included natively on Cornerstone Pro ($499/mo flat, up to 30 users).",
  },
  {
