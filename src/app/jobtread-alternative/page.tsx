...
export const metadata = {
  title: "JobTread Alternative for Home Builders | Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢",
  description:
    "JobTread alternative with action-taking AI agents (396+ skills), structural options engine, and 37+ named webhook events. Home-builder native. Plans from $149/mo to $599/mo flat - no per-user fees.",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "AI agents that take real actions (Cornerstone Pro / Pro+)", cornerstone: true, competitor: "limited", note: "Foreman AI (Pro+ at $499/mo) reads AND writes data - creates POs, updates options, generates SOWs, runs bid comparisons. 396+ purpose-built skills. JobTread's AI Connector lets you plug in third-party AI (ChatGPT, Claude) for chat-style assistance - it doesn't ship native action-taking agents." },
  ...
  { feature: "37+ named webhook events (typed payloads, HMAC)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 37+ named events with typed payloads, HMAC signatures, delivery logs, auto-retry. JobTread has webhook capability via Zapier - we ship the full named event catalog with payload schemas and docs." },
  { feature: "BYOA (Bring Your Own Agent)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: public REST API + 37+ named webhook events with typed payloads + the Foreman skill pack endpoint that exposes all 396+ skill schemas in Anthropic, OpenAI, or OpenAPI format \u2014 drop them straight into your own Claude, GPT-4, or LangChain agent and it's instantly fluent in construction. JobTread's AI Connector is a chat bridge to a third-party LLM (~35 mostly-CRUD skills); it doesn't expose its own skill catalog for you to wire into another agent. Different category." },
  { feature: "Public REST API (150+ API endpoints)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 150+ API endpoints, public docs. New endpoints ship as the platform grows. JobTread offers Zapier and AI Connector integrations rather than a full open REST API." },
  ...
  { feature: "Homeowner portal (realtime sync + photos + messaging + ZIP export)", cornerstone: true, competitor: "limited", note: "Real-time buyer portal synced with construction scheduling ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â when framing moves three days, buyers see it instantly. Plus: (1) builder/PM uploads job-site photos to every milestone (up to 5 photos per milestone via a camera button on the task row), (2) built-in messaging app between builder and customer with a permanent searchable record, and (3) one-click ZIP download of all job photos. JobTread has a client portal but it's general-contractor-shaped ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â not new-construction milestone-driven." },
  ...
  { feature: "Bid management", cornerstone: true, competitor: true, note: "Both ship bid management. Cornerstone Pro+ adds the 7-wave automated bidding pipeline (cold call ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ onboarded)." },
  { feature: "User caps (30 Starter/Builder/Pro Ãƒâ€šÃ‚Â· 60 Pro+)", cornerstone: true, competitor: false, note: "Cornerstone: every plan, every tier. JobTread: $20/user (tiered breaks above 10 users)." },
  { feature: "Pricing model", cornerstone: "Flat ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â up to 30 users (60 on Pro+)", competitor: "$199 + $20/user", note: "Cornerstone is flat at every tier. JobTread is $199 base plus $20 per user, so the bill grows with your crew. Different model entirely ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â but more importantly, these aren't priced against the same product. JobTread doesn't ship an options engine, floorplan pricing matrix, designer packages, or multi-community pipelines at any user count." },
  { feature: "Cornerstone tiers (flat ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â up to 30 users ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ 60 on Pro+)", cornerstone: "$149 / $299 / $499 / $599", competitor: "ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â", note: "Starter ($149): scheduling, permits, homeowner portal. Builder ($299): adds sales pipeline, purchasing, design center with options engine and designer packages. Pro ($499): adds Foreman AI + Blueprint AI. Pro+ ($599): adds REST API, BYOA, 37+ named webhook events, 7-wave bidding." },
];
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "396+ skills vs ~35 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â and ours chain together", desc: "Foreman AI (Cornerstone Pro $499/mo) ships 396+ purpose-built construction skills that chain together into real workflows: read a blueprint, learn your fixture preferences, build a complete lighting package, tag everything with option classes for the design center ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â in one prompt. JobTread's AI Connector exposes ~35 mostly-CRUD skills (list, create, search) and routes you back to ChatGPT/Claude for the thinking. Different category: action agent that chains and learns vs chat bridge to a generic LLM." },
  { title: "Foreman learns YOUR build style automatically", desc: "Cornerstone's learnBuilderPreferences skill (shipped May 12, 2026) reads your existing floorplan takeoffs and figures out YOUR defaults ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â if your bedrooms always get recessed cans, that's the default next time. Every Foreman skill checks learned preferences before falling back to hardcoded values. The more floorplans you build, the smarter Foreman gets for YOUR org specifically. JobTread's AI stays static ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â it doesn't get smarter with each project." },
  { title: "Flat pricing, no per-user math", desc: "Cornerstone Starter $149, Builder $299, Pro $499, Pro+ $599 - flat at every tier ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â up to 30 users (60 on Pro+). JobTread starts $199 + $20/user; a 20-person team is $599/mo. Bring on your whole crew without watching the meter." },
];

const faqItems: FAQItem[] = [
  {
    q: "What's the best JobTread alternative for home builders?",
    a: "Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ is the purpose-built JobTread alternative for home builders. Where JobTread is designed for general contractors, remodelers, and custom builders (all on one flat plan), Cornerstone is built specifically for production - with a structural options engine, designer packages, multi-community pipelines, lot management, and pre-sale design center. JobTread covers GC workflows broadly; Cornerstone goes deep on the production-builder workflow.",
  },
  {
    q: "How does Cornerstone's pricing compare to JobTread's?",
    a: "Honest answer: they're not really priced against the same product, so per-user math is a distraction. JobTread is one flat plan at $199/mo base plus $20 per user. Cornerstone is tiered: Starter $149/mo (scheduling + portal), Builder $299/mo (adds sales pipeline, purchasing, design center with options engine and designer packages), Pro $499/mo (adds Foreman AI + Blueprint AI), Pro+ $599/mo (adds REST API, BYOA, 37+ named webhook events, 7-wave bidding). Every Cornerstone tier is flat with up to 30 users (60 on Pro+). The real difference isn't price-per-user ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â it's that JobTread doesn't have a structural options engine, floorplan pricing matrix, multi-community pipelines, or designer packages at any plan or any team size. If you need those, JobTread isn't an option regardless of cost.",
  },
  {
    q: "How is Foreman AI different from JobTread's AI Connector?",
    a: "TheyÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢re in different categories. JobTread's AI Connector is a bridge: it exposes ~35 mostly basic CRUD skills (list homes, create vendor, search parts) and routes the thinking back to a third-party LLM like ChatGPT or Claude. Foreman AI is a native construction agent with 396+ purpose-built skills that chain together into real workflows. One prompt can read a blueprint, learn your fixture preferences from past takeoffs, build a complete fixture-by-fixture lighting package, and tag everything with option classes for the design center ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â all in a single call against your live data. And because Foreman ships learnBuilderPreferences, every skill gets smarter the more floorplans you set up; JobTread's AI stays static. Foreman is included natively on Cornerstone Pro ($499/mo flat, up to 30 users).",
  },
  {
    q: "Can I migrate from JobTread to Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢?",
  ...
  {
    q: "Does Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ have JobTread's scheduling features?",
    a: "Yes - Gantt charts, dependencies, cascade scheduling, vendor notifications, and task management are all included starting on the Starter plan. Cornerstone Pro+ adds 37+ named webhook events on schedule changes, so you can wire external systems (SMS via Twilio, voice via Bland or Retell) to your schedule triggers without code.",
  },
  {
    q: "How does Cornerstone's BYOA compare to JobTread's AI Connector?",
    a: "Both platforms let you connect external AI to your construction data, but the architecture is different. JobTread's AI Connector is a chat bridge that exposes ~35 mostly-CRUD skills and routes the thinking back to a third-party LLM (ChatGPT, Claude). Cornerstone's BYOA (Pro+ at $599/mo) gives your own agent three things: (1) public REST API with 150+ API endpoints, (2) 37+ named webhook events with typed payload schemas (home created, bid accepted, schedule cascade, etc.) so your agent can react to platform events in real time, and (3) the Foreman skill pack endpoint that returns all 396+ Foreman skill definitions in Anthropic, OpenAI, or OpenAPI format \u2014 drop them into any Claude, GPT-4, or LangChain agent and it's instantly fluent in construction. JobTread doesn't ship a comparable skill-catalog endpoint. Cornerstone's edge: deeper read+write surface, richer event catalog, and a ready-made skill pack so your own agent gets the same construction intelligence Foreman has.",
  },
  {
  ...
  {
    q: "Does Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ have a free trial?",
...
export default function JobtreadAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="emerald"
      heroParagraph="Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ is the JobTread alternative purpose-built for home builders. Floorplan pricing matrix, structural options engine, designer packages, multi-community pipelines - home-builder-native by design. On Pro ($499/mo flat) you get Foreman AI's 100+ action-taking skills; on Pro+ ($599/mo flat) you add the public REST API and 37+ named webhook events. Flat pricing ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â up to 30 users on Starter, Builder, Pro Ãƒâ€šÃ‚Â· 60 users on Pro+ (no per-seat fees within tier)."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="JobTread vs Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ - focused on home builder workflows and AI capability."
      ...
      faqSubtitle="Common questions about switching to Cornerstone PMÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ from JobTread."
      faqItems={faqItems}
