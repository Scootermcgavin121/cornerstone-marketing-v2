...
const pricing: Category = {
  ...
  items: [
    ...
    },
    {
      ...
      aText:
        "Yes - the 2-year free beta is open to the first 100 home builders, no credit card and no contract. Beta includes every feature on the Pro plan including Foreman AI (117+ skills) and Blueprint AI takeoffs. Request access at /beta.",
      a: (
        <>
          Yes - the <strong>2-year free beta</strong> is open to the first 100 home builders, no credit card and
          no contract. Beta includes every feature on the Pro plan including Foreman AI (117+ skills) and Blueprint AI
    ...
    },
    {
      ...
      aText:
        "Cornerstone PM™ ships 5 native AI agents. AI Support Agent is on every plan from Starter ($149/mo). AI MLS Listing Generator is on Builder ($299/mo) and above. Foreman AI (117+ skills) and Blueprint AI are on Pro ($499/mo). Bid Import AI and BYOA are on Pro+ ($599/mo).",
      a: (
        <>
          ...
          ($299/mo) and above. <A href="/foreman">Foreman AI</A> (117+ skills) and <A href="/ai-takeoff">Blueprint AI</A>{" "}
    ...
    },
    {
      ...
      aText:
        "Beta access for two years is free for the first 100 home builders. It includes every Pro plan feature: scheduling, sales pipeline, purchasing, design center, options engine, Foreman AI (117+ skills), Blueprint AI takeoffs, and the homeowner portal. After beta, plans start at $149/mo.",
      a: (
        <>
          Beta access for two years is free for the first 100 home builders. It includes every Pro plan feature:
          scheduling, sales pipeline, purchasing, design center, options engine, Foreman AI (117+ skills), Blueprint AI
...
const ai: Category = {
  ...
  items: [
    ...
    },
    {
      ...
      aText:
        "BYOA lets you connect Claude, ChatGPT, or any custom AI agent to live Cornerstone data via the REST API (40+ endpoints and growing) and 37+ named webhook event types (catalog growing). Build your own scheduling automations, run your own bid analyses, or wire Cornerstone into an internal workflow. Included on Pro+ ($599/mo).",
      a: (
        <>
          BYOA lets you connect Claude, ChatGPT, or any custom AI agent to live Cornerstone data via the{" "}
          <A href="/api-access">REST API (40+ endpoints and growing)</A> and 37+ named webhook event types (catalog growing). Build your own scheduling
    ...
    },
    {
      ...
      aText:
        "ChatGPT is a general LLM with no knowledge of your homes, vendors, or build pipeline. Foreman AI is grounded in your live Cornerstone data and your role permissions, with 117+ purpose-built skills that execute real actions - rescheduling tasks, notifying vendors, generating MLS listings, drafting bid requests. ChatGPT can describe what to do; Foreman AI does it.",
      a: (
        <>
...
const design: Category = {
  ...
  items: [
    ...
    },
    {
      ...
      aText:
        "Options Attributes let you define attribute groups (Door Style, Wood Species, Finish, Overlay, Door Treatment) for a product category and manage every possible combination through multiplication instead of manual data entry. 5 cabinet series × 23 door styles × 8 wood species × 38 finishes × 2 overlays × 3 door treatments = over 7,000 variations managed through just 5 options and 5 attribute groups. Compatibility rules prevent invalid combinations. Per-value pricing modifiers, visual image catalogs, and auto-generated vendor bid templates (Excel) that vendors fill in and upload — pricing imports back as real cost data tied to every attribute value.",
      a: (
        <>
...
const api: Category = {
  ...
  items: [
    ...
    },
    {
      ...
      aText:
        "Yes. Pro+ ($599/mo) includes BYOA + full REST API access. Connect Claude, ChatGPT, or any custom agent to live purchasing, bid, vendor, and budget data through 40+ endpoints (and growing) with scoped Bearer-token auth.",
      a: (
        <>
          Yes. Pro+ ($599/mo) includes BYOA + full <A href="/api-access">REST API access</A>. Connect Claude, ChatGPT,
          or any custom agent to live purchasing, bid, vendor, and budget data through 40+ endpoints (and growing) with scoped
          Bearer-token auth.
        </>
      ),
    },
    ...
    },
    {
      ...
      aText:
        "Buildertrend has limited integration capabilities and historically required enterprise contracts for API access. Cornerstone PM™ ships a public, documented REST API with 40+ endpoints and growing rapidly on Pro+ ($599/mo) - no separate contract, no enterprise gating.",
      a: (
        <>
          Buildertrend has limited integration capabilities and historically required enterprise contracts for API
          access. Cornerstone PM™ ships a public, documented REST API with <strong>40+ endpoints (and growing) on Pro+ ($599/mo)</strong>
...
const comparisons: Category = {
  ...
  items: [
    ...
    },
    {
      ...
      aText:
        "Native AI agents (Foreman AI's 117+ skills, Blueprint AI takeoffs, Bid Import AI), a structural options engine, floorplan pricing matrix, multi-community pipelines, and a public REST API on Pro+ ($599/mo). Buildertrend's price floor is $499/mo - the same as Cornerstone Pro - and includes none of these.",
      a: (
        <>
          Native AI agents (<A href="/foreman">Foreman AI</A>'s 117+ skills, <A href="/ai-takeoff">Blueprint AI</A>{" "}
