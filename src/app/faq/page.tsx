  ...
  items: [
    {
      ...
      aText:
        "Cornerstone PMÃ¢â€žÂ¢ starts at $149/mo (Starter), $299/mo (Builder, adds purchasing/sales/design center), $499/mo (Pro, adds Foreman AI + Blueprint AI), and $599/mo (Pro+, adds REST API, BYOA, and Bid Import AI). Every plan includes up to 30 users (60 on Pro+) with no per-seat fees within your tier. See full plan details on /pricing.",
      a: (
        <>
    ...
    },
    {
      ...
      aText:
        "Yes - the 2-year free beta is open to the first 100 home builders, no credit card and no contract. Beta includes every feature on the Pro plan including Foreman AI (396+ skills) and Blueprint AI takeoffs. Request access at /beta.",
      a: (
        <>
          Yes - the <strong>2-year free beta</strong> is open to the first 100 home builders, no credit card and
          no contract. Beta includes every feature on the Pro plan including Foreman AI (396+ skills) and Blueprint AI
    ...
    },
    {
      ...
      aText:
        "No. Every Cornerstone PMÃ¢â€žÂ¢ plan includes up to 30 users (60 on Pro+) within your tier, plus unlimited subcontractors and unlimited buyers at no additional charge - add your whole team, every vendor, and every homeowner without per-seat math.",
      a: (
        <>
          <strong>No.</strong> Every Cornerstone PMÃ¢â€žÂ¢ plan includes up to 30 users (60 on Pro+), unlimited subcontractors, and
    ...
    },
    {
      ...
      aText:
        "Cornerstone PMÃ¢â€žÂ¢ ships 5 native AI agents. AI Support Agent is on every plan from Starter ($149/mo). AI MLS Listing Generator is on Builder ($299/mo) and above. Foreman AI (396+ skills) and Blueprint AI are on Pro ($499/mo). Bid Import AI and BYOA are on Pro+ ($599/mo).",
      a: (
        <>
    ...
    },
    {
      ...
      aText:
        "Beta access for two years is free for the first 100 home builders. It includes every Pro plan feature: scheduling, sales pipeline, purchasing, design center, options engine, Foreman AI (396+ skills), Blueprint AI takeoffs, and the homeowner portal. After beta, plans start at $149/mo.",
      a: (
        <>
          Beta access for two years is free for the first 100 home builders. It includes every Pro plan feature:
          scheduling, sales pipeline, purchasing, design center, options engine, Foreman AI (396+ skills), Blueprint AI
    ...
    },
    {
      ...
      aText:
        "Yes. Cornerstone PMÃ¢â€žÂ¢ Starter is $149/mo with up to 30 users (60 on Pro+); Buildertrend starts at $499/mo. The full Cornerstone Pro plan is $499/mo - same as Buildertrend's entry tier - and includes Foreman AI and Blueprint AI that Buildertrend doesn't offer at any price.",
      a: (
        <>
          Yes. Cornerstone PMÃ¢â€žÂ¢ Starter is <strong>$149/mo</strong> with up to 30 users (60 on Pro+); Buildertrend starts at{" "}
...
const ai: Category = {
  ...
  items: [
    ...
    },
    {
      ...
      aText:
        "BYOA lets you connect Claude, ChatGPT, or any custom AI agent to live Cornerstone data via the REST API (150+ API endpoints) and 37+ named webhook event types (catalog growing). Build your own scheduling automations, run your own bid analyses, or wire Cornerstone into an internal workflow. Included on Pro+ ($599/mo).",
      a: (
        <>
          BYOA lets you connect Claude, ChatGPT, or any custom AI agent to live Cornerstone data via the{" "}
          <A href="/api-access">REST API (150+ API endpoints)</A> and 37+ named webhook event types (catalog growing). Build your own scheduling
    ...
    },
    {
      ...
      aText:
        "ChatGPT is a general LLM with no knowledge of your homes, vendors, or build pipeline. Foreman AI is grounded in your live Cornerstone data and your role permissions, with 396+ purpose-built skills that execute real actions - rescheduling tasks, notifying vendors, generating MLS listings, drafting bid requests. ChatGPT can describe what to do; Foreman AI does it.",
      a: (
        <>
...
const design: Category = {
  ...
  items: [
    ...
    },
    {
      ...
      aText:
        "Options Attributes let you define attribute groups (Door Style, Wood Species, Finish, Overlay, Door Treatment) for a product category and manage every possible combination through multiplication instead of manual data entry. 5 cabinet series Ãƒâ€” 23 door styles Ãƒâ€” 8 wood species Ãƒâ€” 38 finishes Ãƒâ€” 2 overlays Ãƒâ€” 3 door treatments = over 7,000 variations managed through just 5 options and 5 attribute groups. Compatibility rules prevent invalid combinations. Per-value pricing modifiers, visual image catalogs, and auto-generated vendor bid templates (Excel) that vendors fill in and upload Ã¢â‚¬â€ pricing imports back as real cost data tied to every attribute value.",
      a: (
        <>
  ...
  items: [
    {
      ...
      aText:
        "Yes - a public REST API with 150+ API endpoints, scoped Bearer-token authentication, and full documentation at app.cornerstonepm.ai/developers. New endpoints ship as the platform grows. All core data (schedules, vendors, lots, options, bids, budgets, takeoffs) is accessible. Included on Pro+ ($599/mo). See /api-access.",
      a: (
        <>
          Yes - a public REST API with <strong>150+ API endpoints</strong>, scoped Bearer-token authentication, and full
    ...
    },
    {
      ...
      aText:
        "Yes. Pro+ ($599/mo) includes BYOA + full REST API access. Connect Claude, ChatGPT, or any custom agent to live purchasing, bid, vendor, and budget data through 150+ API endpoints with scoped Bearer-token auth.",
      a: (
        <>
          Yes. Pro+ ($599/mo) includes BYOA + full <A href="/api-access">REST API access</A>. Connect Claude, ChatGPT,
          or any custom agent to live purchasing, bid, vendor, and budget data through 150+ API endpoints with scoped
          Bearer-token auth.
        </>
      ),
    },
    ...
    },
    {
      ...
      aText:
        "Buildertrend has limited integration capabilities and historically required enterprise contracts for API access. Cornerstone PMÃ¢â€žÂ¢ ships a public, documented REST API with 150+ API endpoints on Pro+ ($599/mo) - no separate contract, no enterprise gating.",
      a: (
        <>
          Buildertrend has limited integration capabilities and historically required enterprise contracts for API
          access. Cornerstone PMÃ¢â€žÂ¢ ships a public, documented REST API with <strong>150+ API endpoints on Pro+ ($599/mo)</strong>
...
const comparisons: Category = {
  ...
  items: [
    ...
    },
    {
      ...
      aText:
        "Native AI agents (Foreman AI's 396+ skills, Blueprint AI takeoffs, Bid Import AI), a structural options engine, floorplan pricing matrix, multi-community pipelines, and a public REST API on Pro+ ($599/mo). Buildertrend's price floor is $499/mo - the same as Cornerstone Pro - and includes none of these.",
      a: (
        <>
          Native AI agents (<A href="/foreman">Foreman AI</A>'s 396+ skills, <A href="/ai-takeoff">Blueprint AI</A>{" "}
    ...
    },
    {
      ...
      aText:
        "Cornerstone PMÃ¢â€žÂ¢ is a modern, web-based, mobile-friendly platform; BuildPro's UI is dated and Windows/Citrix-centric. Cornerstone ships native AI agents BuildPro doesn't offer at any tier, and is operational in hours at $149/mo with up to 30 users (60 on Pro+) vs BuildPro's $25k-$75k+ implementation budgets.",
      a: (
        <>
