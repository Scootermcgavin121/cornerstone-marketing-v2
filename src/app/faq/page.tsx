...
const api: Category = {
  ...
  items: [
    ...
    },
    {
      ...
      aText:
        "Buildertrend has limited integration capabilities and historically required enterprise contracts for API access. Cornerstone PM™ ships a public, documented REST API with 150+ API endpoints on Pro+ ($599/mo) - no separate contract, no enterprise gating.",
      a: (
        <>
          Buildertrend has limited integration capabilities and historically required enterprise contracts for API
          access. Cornerstone PM™ ships a public, documented REST API with <strong>150+ API endpoints on Pro+ ($599/mo)</strong>
