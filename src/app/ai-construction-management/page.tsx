...
export const metadata = {
  ...
  description:
    "Foreman AI is the AI agent built into Cornerstone PM — 45+ purpose-built skills for home builder scheduling, purchasing, sales pipeline, and design center. Not a chatbot. Not bolted on.",
};
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-400 text-xs font-semibold mb-6">
            ...
            FOREMAN AI · BY CORNERSTONE PM · 45+ SKILLS
          </div>
          ...
          <p className="text-lg text-slate-500 max-w-2xl mx-auto mb-10">
            45+ purpose-built skills. Knows what a floorplan is, what a spec level means, and what a punch list looks like for a home under construction. Built for home builders specifically — not adapted from generic commercial PM tools.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl bg-emerald-500/5 border border-emerald-500/20 p-6">
              ...
              <ul className="space-y-3 text-slate-400 text-sm">
                ...
                <li className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                  45+ purpose-built skills — not generic AI features
                </li>
              </ul>
            </div>
          </div>
