...
const modules = [
  ...
  { name: "Foreman AI", href: "/foreman", desc: "117+ AI skills across 17 categories. Plain-English commands against live builder data.", color: "blue" },
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-slate-400 leading-relaxed mb-4">
                ...
                directly to your live data: Foreman AI (117+ skills) and Blueprint AI (floor plan reader).
              </p>
            ...
            <div className="space-y-3">
              {[
                "117+ Foreman AI skills across 17 categories",
