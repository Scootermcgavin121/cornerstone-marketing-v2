...
const modules = [
  ...
  { name: "Foreman AI", href: "/foreman", desc: "100+ AI skills across 16 categories. Plain-English commands against live builder data.", color: "blue" },
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-slate-400 leading-relaxed mb-4">
                ...
                directly to your live data: Foreman AI (110+ skills) and Blueprint AI (floor plan reader).
              </p>
            ...
            <div className="space-y-3">
              {[
                "110+ Foreman AI skills across 16 categories",
