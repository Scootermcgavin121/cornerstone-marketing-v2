...
export const metadata: Metadata = {
  title: "Builder AI Software: Why Home Builders Need Purpose-Built AI (Not Generic Tools) â€” Cornerstone PM Blog",
  description:
    ...
    <main className="bg-slate-950 text-white min-h-screen">
      ...
      <article className="max-w-3xl mx-auto px-4 pt-28 pb-24">
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-6 text-slate-300 leading-relaxed">
          ...
          <p>
            Foreman AI is the AI agent inside Cornerstone PM. It was designed from the ground up for home builders â€” not adapted from a generic AI assistant. Here&apos;s what that means in practice:
          </p>
          <p>
          ...
          <p>
            It reads and writes real data â€” your parts catalog, vendor list, home statuses, buyer selections, budgets, design center options, and sales pipeline. It&apos;s not summarizing text you paste in. It&apos;s running actual queries against your actual database and returning actual results.
          </p>
          <p>
          ...
          <div className="space-y-4 my-6">
            {[
              ...
              {
                prompt: "Show me vendor performance â€” who's winning our bids and who's behind on insurance renewals",
          ...
          <p>
            None of those responses required you to paste in data. None required you to explain what a design center is. Foreman already knows â€” because it has access to your actual records and it understands how home builders work.
          </p>

          <h2 className="text-2xl font-bold text-white mt-10 mb-4">The bottom line</h2>
          <p>
            Builder AI software is a real thing now â€” but you have to know what to look for. The difference between generic AI and purpose-built builder AI is the difference between a tool that can answer questions and a tool that can run your business.
          </p>
          <p>
            Generic AI will tell you what a budget variance is. Purpose-built builder AI will show you exactly which homes have one â€” and how much it&apos;s going to cost you if you don&apos;t act.
          </p>
          <p>
        ...
        <div className="mt-12 p-6 rounded-2xl border border-amber-500/20 bg-amber-500/5">
          ...
          <p className="text-slate-400 text-sm mb-4">
            Foreman AI â€” 47 skills, real data access, persistent memory. Beta is free for 2 years.
          </p>
          <Link
            href="/beta"
