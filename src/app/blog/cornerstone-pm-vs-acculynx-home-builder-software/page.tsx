...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PM\u2122 offers a production home builder design center with 64 curated Designer Packages, per-floorplan options reused across plan repeats, multi-community vendor assignment, AI material takeoff (130+ scopes from a PDF in <60 seconds), Foreman AI with 110+ skills, side-by-side vendor bid comparison, and a buyer-facing design portal \u2014 none of which exist in AccuLynx.",
  },
  {
  ...
  },
  {
    ...
    a: "Cornerstone PM\u2122 ships five native AI agents: Blueprint AI (material takeoff from floor plan PDFs), Foreman AI (110+ skills for purchasing, scheduling, vendor management, and reporting), Bid Import AI (auto-maps vendor bid spreadsheets to scope items), AI MLS Listing Generator, and an AI Support Agent. All are bundled at no extra cost on the Pro+ plan.",
  },
];
...
const compareRows: CompareRow[] = [
  ...
  { feature: "Foreman AI (110+ skills)", acculynx: false, cornerstone: true },
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-6 text-slate-300 leading-relaxed">
          ...
          <ul className="space-y-2 text-slate-300 ml-4 list-disc">
            ...
            <li>
              ...
              110+ skills covering purchasing workflows, vendor management, schedule optimization,
