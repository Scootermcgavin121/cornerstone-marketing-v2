...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [{ url: "https://www.cornerstonepm.ai/blog/foreman-ai-skills.png", width: 1024, height: 1024, alt: "Foreman AI managing residential construction with 110+ skills across scheduling, sales, purchasing, and design center" }],
  }
};
  ...
  return (
    <main className="bg-slate-950 text-white min-h-screen">
      ...
      <article className="max-w-3xl mx-auto px-4 pt-28 pb-24">
        ...
        <BlogHero src="/blog/foreman-ai-skills.png" alt="Foreman AI managing residential construction with 110+ skills across scheduling, sales, purchasing, and design center" />
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-6 text-slate-300 leading-relaxed">
          ...
          <p>
            Foreman AI is the AI agent built into Cornerstone PM™ &mdash; purpose-built for home builders with 110+ skills across data management, AI-powered analysis, document generation, and system intelligence.
          </p>
          <p>
        ...
        <div className="mt-12 p-6 rounded-2xl border border-amber-500/20 bg-amber-500/5">
          ...
          <p className="text-slate-400 text-sm mb-4">
            110+ purpose-built construction skills. Beta access is free for 2 years for early adopters.
          </p>
          <Link
            href="/beta"
