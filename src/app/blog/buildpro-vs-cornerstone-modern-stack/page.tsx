    ...
    <main className="bg-slate-950 text-white min-h-screen">
      ...
      <article className="max-w-3xl mx-auto px-4 pt-28 pb-24">
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-6 text-slate-300 leading-relaxed">
          ...
          <p>
            For a builder running 20—œ80 homes per year without a dedicated IT department, that
          ...
          <ul className="space-y-2 text-slate-300 ml-4 list-disc">
            ...
            <li>
              <strong className="text-white">Foreman AI™</strong> — a 110-skill agent that reads
          ...
          <p>
            ...
            evaluating. Replacing 4—œ8 hours of manual estimating per plan with a 60-second AI
