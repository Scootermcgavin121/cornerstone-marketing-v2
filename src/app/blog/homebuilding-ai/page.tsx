    ...
    <main className="bg-slate-950 text-white min-h-screen">
      ...
      <article className="max-w-3xl mx-auto px-4 pt-28 pb-24">
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-6 text-slate-300 leading-relaxed">
          ...
          <p>
            These examples are from Cornerstone PM&apos;s Foreman AI — a 47-skill AI agent purpose-built for home builders that reads and writes real construction data in plain English.
          </p>
          ...
          <p>
            Cornerstone PM is building that second kind of tool. Foreman AI — 47 purpose-built skills, real data access, persistent memory. Beta is open now.
          </p>
        </div>
