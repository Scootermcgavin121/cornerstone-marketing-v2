      ...
      <article className="max-w-3xl mx-auto px-4 pt-28 pb-24">
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-6 text-slate-300 leading-relaxed">
          <p className="text-xl text-slate-300 font-light">
            ...
            +84% jump in capability in 42 days — and the count keeps climbing.
          </p>
          ...
          <ul className="list-disc list-outside pl-6 space-y-3 marker:text-amber-400">
            <li>
              ...
              update, and remove takeoff line items as well as adjust quantities — in plain English, against
              the same live data your team is editing. Cleanup that used to mean a CSV round-trip now happens in
              one prompt.
            </li>
            <li>
              <strong className="text-white">Vendor scorecards on demand.</strong> Ask “who&apos;s our most
              reliable plumbing vendor this year?” Foreman pulls bid response rates, win rates, and on-time
              metrics from the underlying data — not opinions, not vibes.
            </li>
            <li>
            ...
            <li>
              ...
              stage, close rates by agent or by community — in one prompt instead of three reports.
            </li>
            <li>
          ...
          <p className="mt-6">
            ...
            list generation, image vision (paste any screenshot — product photo, vendor quote, supplier page
            — and Foreman reads it), anti-bot web scraping for Home Depot / Ferguson / Lowe&apos;s pricing,
          ...
          <p>
            ...
            jump from 45 to 83 is the difference between “answers questions about my data” and
            “runs entire workflows against my data while I&apos;m on a call.”
          </p>
          ...
          <p>
            ...
            — it auto-summarizes older messages mid-session so the recent context stays word-for-word intact
          ...
          <div className="not-prose mt-10 p-6 rounded-2xl bg-slate-900/80 border border-slate-800">
            ...
            <p className="text-slate-400 mb-5 text-sm leading-relaxed">
              See Foreman manage real builder data — parts, vendors, homes, design center, sales pipeline
              — from plain English commands. Beta access is free for 2 years for the first 100 home builders.
            </p>
          ...
          <p className="text-sm text-slate-500 italic mt-10">
            Foreman AI is part of Cornerstone PM™ — home builder software built for production, semi-custom,
            and custom builders running 5–200 homes a year. Flat pricing from $149/mo with up to 30 users (60 on Pro+).
          </p>
        </div>
      </article>
