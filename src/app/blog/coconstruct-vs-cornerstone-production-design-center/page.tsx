...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PM offers: 64 Designer Packages with auto-locking category options, per-floorplan options priced once and reused across plan repeats, multi-community vendor assignment, AI material takeoff from PDFs (130+ scopes in <60 seconds), Foreman AI with 117+ skills, Structural vs Designer scope separation for bid templates, Area Cost Pricing for community extras, and zero filler/default pricing. None of these production-residential workflows exist in CoConstruct.",
  },
  {
...
const compareRows: CompareRow[] = [
  ...
  { feature: "Foreman AI (117+ skills)", coconstruct: false, cornerstone: true },
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-6 text-slate-300 leading-relaxed">
          ...
          <ul className="space-y-2 text-slate-300 ml-4 list-disc">
            ...
            <li>
              ...
              117+ skills that reads AND writes data. In the design center context, Foreman can
