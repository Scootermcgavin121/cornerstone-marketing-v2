    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          {/* 396+ skills breakdown */}
          <div className="mb-10">
            <p className="text-center text-slate-400 text-sm font-semibold uppercase tracking-widest mb-6">396+ skills across 20 categories</p>
            ...
            <p className="text-center text-slate-600 text-xs mt-3">20 categories. 396+ skills. Always shipping more.</p>
          </div>
