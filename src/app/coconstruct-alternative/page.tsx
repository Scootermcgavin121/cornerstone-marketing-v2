...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "MCP server + Public REST API (150+ API endpoints)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: built-in MCP server (connect Claude Desktop, Cursor, or Windsurf in ~30 seconds) plus 150+ API endpoints with public docs. New endpoints ship as the platform grows. Buildertrend: enterprise API only, no MCP server." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Action-taking AI on Pro — 396+ skills", desc: "Foreman AI (Cornerstone Pro, $499/mo) creates POs, updates design options, generates SOWs. Greets you by your chosen name, learns your go-to vendors and habits, gets more intuitive every session — custom-coded into the app, not a generic chatbot bolt-on. Built-in session compaction for marathon workflows. No other construction AI does this." },
...
export default function CoConstructAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="cyan"
      heroParagraph="CoConstruct was merged into Buildertrend in 2022. If you're frustrated with the transition - higher prices, different workflows, no AI - Cornerstone PM™ is the home-builder alternative. Native AI agents (Foreman AI on Pro $499/mo), options engine (Builder $299/mo), 37+ named webhook events (Pro+), and up to 30 users (60 on Pro+) from $149/mo."
