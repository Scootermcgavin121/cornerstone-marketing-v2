...
export const metadata = {
  title: "CoConstruct Alternative - Frustrated by the Buildertrend Merger? | Cornerstone PMâ„¢",
  description:
    "CoConstruct was merged into Buildertrend. If you're frustrated with the transition, Cornerstone PMâ„¢ offers a home-builder platform with AI agents (Pro $499/mo) from $149/mo.",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Vendor portal â€” no login required (email magic links)", cornerstone: true, competitor: false, note: "Vendors confirm tasks, accept schedule changes, and submit bids â€” all via secure magic links sent straight to their email. No app to download, no Cornerstone account to create, no password to remember. Click the link, do the thing, done. Biggest friction-killer for trade partners in the industry." },
...
const faqItems: FAQItem[] = [
  ...
  {
    q: "Is Cornerstone PMâ„¢ cheaper than Buildertrend (the platform CoConstruct became)?",
  ...
  {
    q: "Does Cornerstone PMâ„¢ have a homeowner portal like CoConstruct had?",
...
export default function CoConstructAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="cyan"
      heroParagraph="CoConstruct was merged into Buildertrend in 2022. If you're frustrated with the transition - higher prices, different workflows, no AI - Cornerstone PMâ„¢ is the home-builder alternative. Native AI agents (Foreman AI on Pro $499/mo), options engine (Builder $299/mo), 30+ named webhook events (Pro+), and unlimited users from $149/mo."
      ...
      whySwitchHeadline="Why CoConstruct refugees choose Cornerstone PMâ„¢"
