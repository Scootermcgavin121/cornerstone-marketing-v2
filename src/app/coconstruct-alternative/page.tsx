...
export const metadata = {
  title: "CoConstruct Alternative - Frustrated by the Buildertrend Merger? | Cornerstone PMÃ¢â€žÂ¢",
  description:
    "CoConstruct was merged into Buildertrend. If you're frustrated with the transition, Cornerstone PMÃ¢â€žÂ¢ offers a home-builder platform with AI agents (Pro $499/mo) from $149/mo.",
  alternates: { canonical: "https://www.cornerstonepm.ai/coconstruct-alternative" },
};

const comparisonRows: ComparisonRow[] = [
  { feature: "Still an independent product", cornerstone: true, competitor: false, note: "CoConstruct was acquired and merged into Buildertrend in 2022. Cornerstone PMÃ¢â€žÂ¢ is independent and purpose-built for home builders." },
  { feature: "Built for home builders", cornerstone: true, competitor: false, note: "CoConstruct was built for custom builders and remodelers. Cornerstone PMÃ¢â€žÂ¢ is built across the full home-builder spectrum - production, semi-custom, and custom - with lot management, options engine, and multi-community pipelines that work for all of them." },
  { feature: "Native AI agents (Foreman AI + Blueprint AI)", cornerstone: true, competitor: false, note: "Cornerstone Pro ($499/mo): 396+ Foreman AI skills that read AND write data, plus Blueprint AI floor plan takeoffs in 60 sec. No native AI in Buildertrend/CoConstruct." },
  ...
  { feature: "37+ named webhook events (catalog growing)", cornerstone: true, competitor: false, note: "Cornerstone Pro+ ($599/mo): 37+ named events and counting -- typed payloads, HMAC signatures, delivery logs, auto-retry. New events ship as the platform grows. Buildertrend webhooks are limited and have no public event catalog." },
  { feature: "BYOA (Bring Your Own Agent)", cornerstone: true, competitor: false, note: "Cornerstone Pro+ ($599/mo): wire Claude or ChatGPT to live builder data via public REST API + 37+ named webhook events (catalog growing). Buildertrend has no BYOA support." },
  { feature: "Public REST API (150+ API endpoints)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 150+ API endpoints, public docs. New endpoints ship as the platform grows. Buildertrend: enterprise API only." },
  ...
  { feature: "Vendor portal Ã¢â‚¬â€ no login required (email magic links)", cornerstone: true, competitor: false, note: "Vendors confirm tasks, accept schedule changes, and submit bids Ã¢â‚¬â€ all via secure magic links sent straight to their email. No app to download, no Cornerstone account to create, no password to remember. Click the link, do the thing, done. Biggest friction-killer for trade partners in the industry." },
  ...
  { feature: "Homeowner portal (realtime sync + photos + messaging + ZIP export)", cornerstone: true, competitor: "limited", note: "Cornerstone gives buyers a real-time portal synced with construction scheduling Ã¢â‚¬â€ when framing moves three days, they see it instantly. Plus: (1) builder/PM uploads job-site photos to every milestone (up to 5 photos per milestone via a camera button on the task row), (2) built-in messaging app between builder and customer with a permanent searchable record, and (3) one-click ZIP download of all job photos. CoConstruct (now Buildertrend) has a client portal but the milestone-photo workflow and bulk ZIP export aren't packaged the same way." },
  { feature: "User caps (30 Starter/Builder/Pro Ã‚Â· 60 Pro+)", cornerstone: true, competitor: true, note: "Both include generous user caps. Cornerstone: every tier from $149. Buildertrend: custom pricing - contact for quote." },
  { feature: "Pricing model", cornerstone: "Flat Ã¢â‚¬â€ up to 30 users (60 on Pro+)", competitor: "Custom quote (Buildertrend)", note: "Buildertrend no longer publishes pricing -- custom quotes only. Cornerstone is flat at every tier Ã¢â‚¬â€ up to 30 users (60 on Pro+). More importantly: Buildertrend doesn't ship a structural options engine, floorplan pricing matrix, native AI agents, or 37+ named webhook events at any price point." },
  { feature: "Cornerstone tiers (flat Ã¢â‚¬â€ up to 30 users Ã¢â‚¬Â¢ 60 on Pro+)", cornerstone: "$149 / $299 / $499 / $599", competitor: "--", note: "Starter ($149): scheduling, permits, homeowner portal. Builder ($299): adds sales pipeline, purchasing, design center with options engine and designer packages. Pro ($499): adds Foreman AI + Blueprint AI. Pro+ ($599): adds REST API, BYOA, 37+ named webhook events, 7-wave bidding." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Action-taking AI on Pro Ã¢â‚¬â€ 396+ skills", desc: "Foreman AI (Cornerstone Pro, $499/mo) creates POs, updates design options, generates SOWs. Greets you by your chosen name, learns your go-to vendors and habits, gets more intuitive every session Ã¢â‚¬â€ custom-coded into the app, not a generic chatbot bolt-on. Built-in session compaction for marathon workflows. No other construction AI does this." },
...
const faqItems: FAQItem[] = [
  {
    ...
    a: "If you're frustrated with the CoConstruct-to-Buildertrend transition, Cornerstone PMÃ¢â€žÂ¢ is the cleanest off-ramp. It covers the same core functions (scheduling, homeowner portal, selections, purchasing, bid management) and adds features CoConstruct never had: native AI agents (Foreman AI 396+ skills on Pro $499/mo), structural options engine (Builder $299/mo), 37+ named webhook events (Pro+), and a public REST API (Pro+). The AI Migration Wizard ingests your Buildertrend/CoConstruct export in under a day.",
  },
  {
    q: "Is Cornerstone PMÃ¢â€žÂ¢ a good CoConstruct replacement?",
    a: "For home builders of all types - production, semi-custom, and custom. Cornerstone PMÃ¢â€žÂ¢ covers CoConstruct's core features and adds a structural options engine, floorplan pricing matrix, multi-community pipelines, native AI agents (Pro $499/mo), and a public REST API (Pro+) that CoConstruct never offered. If you're doing highly variable one-off remodel work with no floorplan repeats at all, Buildertrend is the path of least resistance after the merger.",
  },
  {
    q: "How hard is it to migrate from CoConstruct / Buildertrend to Cornerstone PMÃ¢â€žÂ¢?",
...
export default function CoConstructAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="cyan"
      heroParagraph="CoConstruct was merged into Buildertrend in 2022. If you're frustrated with the transition - higher prices, different workflows, no AI - Cornerstone PMÃ¢â€žÂ¢ is the home-builder alternative. Native AI agents (Foreman AI on Pro $499/mo), options engine (Builder $299/mo), 37+ named webhook events (Pro+), and up to 30 users (60 on Pro+) from $149/mo."
      ...
      whySwitchHeadline="Why CoConstruct refugees choose Cornerstone PMÃ¢â€žÂ¢"
