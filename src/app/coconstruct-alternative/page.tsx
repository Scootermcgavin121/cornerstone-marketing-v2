...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Public REST API (59 endpoints)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 59 endpoints, public docs. Buildertrend: enterprise API only." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Action-taking AI on Pro — 45+ skills", desc: "Foreman AI (Cornerstone Pro, $499/mo) creates POs, updates design options, generates SOWs, and remembers your preferences across sessions. Per-user memory. Built-in session compaction for marathon workflows. No other construction AI does this." },
