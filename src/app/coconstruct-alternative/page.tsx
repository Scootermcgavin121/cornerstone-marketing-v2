...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "Action-taking AI on Pro â€” 45+ skills", desc: "Foreman AI (Cornerstone Pro, $499/mo) creates POs, updates design options, generates SOWs. Greets you by your chosen name, learns your go-to vendors and habits, gets more intuitive every session â€” custom-coded into the app, not a generic chatbot bolt-on. Built-in session compaction for marathon workflows. No other construction AI does this." },
