...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Public REST API (40+ endpoints, growing)", cornerstone: true, competitor: "limited", note: "Cornerstone Pro+: 40+ endpoints and growing rapidly, public docs. New endpoints ship as the platform grows. Buildertrend: enterprise API only." },
