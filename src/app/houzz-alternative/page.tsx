...
export const metadata = {
  title: "Houzz Pro Alternative for Home Builders | Cornerstone PMÃ¢â€žÂ¢",
  description:
    "Houzz Pro is built for interior designers and remodelers. Cornerstone PMÃ¢â€žÂ¢ is the Houzz Pro alternative for home builders -- AI agents (Pro $499/mo), options engine, and multi-community management from $149/mo.",
  alternates: { canonical: "https://www.cornerstonepm.ai/houzz-alternative" },
};

const comparisonRows: ComparisonRow[] = [
  { feature: "Built for home builders", cornerstone: true, competitor: false, note: "Houzz Pro is built for interior designers, remodelers, and home improvement pros. Cornerstone PMÃ¢â€žÂ¢ is purpose-built for home builders -- production, semi-custom, and custom -- managing communities of homes, not design portfolios." },
  ...
  { feature: "Public REST API (150+ API endpoints)", cornerstone: true, competitor: false, note: "Cornerstone Pro+: 150+ API endpoints, public docs. New endpoints ship as the platform grows. Houzz Pro has no public API." },
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Cornerstone PMÃ¢â€žÂ¢ is purpose-built for home builders. Beyond the basics (scheduling, client communication, document management from Starter $149/mo), it adds a structural options engine, floorplan pricing matrix, multi-community lot management, 64 Designer Packages curated by an actual interior designer (the same playbook K. Hovnanian Homes uses), native AI agents (Foreman AI 396+ skills on Pro $499/mo, Blueprint AI), 37+ named webhook events (Pro+), and a public REST API.",
  },
  {
    q: "Does Houzz Pro have AI features?",
    a: "Houzz Pro includes AI tools for design assistance and project management -- mood boards, visualizations, and scheduling tools aimed at interior designers and remodelers. Cornerstone's Foreman AI (Pro $499/mo) is a native agent with 100+ construction-specific skills that takes real actions: creates POs, updates design options, generates SOWs, runs bid comparisons, analyzes screenshots with AI vision, and scrapes supplier product pages.",
  },
  {
    q: "Can I migrate from Houzz Pro to Cornerstone PMÃ¢â€žÂ¢?",
  ...
  {
    q: "Does Cornerstone PMÃ¢â€žÂ¢ have a design center like Houzz?",
...
export default function HouzzAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="violet"
      heroParagraph="Houzz Pro is a design platform and marketplace for interior designers and remodelers. Cornerstone PMÃ¢â€žÂ¢ is the alternative for home builders -- structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community lot management, and 396+ AI skills (Pro $499/mo) from $149/mo."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="Houzz Pro vs Cornerstone PMÃ¢â€žÂ¢ -- design platform vs. home-builder platform."
      comparisonRows={comparisonRows}
      trademarkName="Houzz"
      whySwitchHeadline="What home builders get with Cornerstone PMÃ¢â€žÂ¢"
      whySwitchCards={whySwitchCards}
      honestAngle="If you're an interior designer or home remodeler, Houzz Pro is a great tool for portfolio building and lead generation from the Houzz marketplace. This page is for home builders who found Houzz Pro through a search -- you need a different kind of platform, and Cornerstone PMÃ¢â€žÂ¢ is built for your workflows."
      ...
      faqSubtitle="For home builders evaluating Houzz Pro vs Cornerstone PMÃ¢â€žÂ¢."
      faqItems={faqItems}
