...
export const metadata = {
  ...
  description:
    "Houzz Pro is built for interior designers and remodelers. Cornerstone PM is the Houzz Pro alternative for home builders — AI agents, options engine, and multi-community management from $149/mo.",
  alternates: { canonical: "https://www.cornerstonepm.ai/houzz-alternative" },
};

const comparisonRows: ComparisonRow[] = [
  { feature: "Built for home builders", cornerstone: true, competitor: false, note: "Houzz Pro is built for interior designers, remodelers, and home improvement pros. Cornerstone PM is purpose-built for home builders managing communities of homes — production, semi-custom, and custom." },
  ...
  { feature: "Designer Packages (64 curated by an actual interior designer, 7 categories)", cornerstone: true, competitor: false, note: "Design center packages curated by an actual interior designer — the same playbook K. Hovnanian Homes uses. Buyers pick a package; all category options auto-lock." },
