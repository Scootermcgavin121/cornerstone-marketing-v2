...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Public REST API (59 endpoints)", cornerstone: true, competitor: false, note: "Cornerstone Pro+: 59 endpoints, public docs. Houzz Pro has no public API." },
  ...
  { feature: "Homeowner portal", cornerstone: true, competitor: false, note: "Construction-specific buyer portal: milestones, selections, documents. Houzz is a consumer marketplace." },
