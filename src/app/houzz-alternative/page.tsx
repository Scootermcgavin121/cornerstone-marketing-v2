...
export const metadata = {
  title: "Houzz Pro Alternative for Production Home Builders | Cornerstone PM",
  description:
    "Houzz Pro is built for interior designers and remodelers. Cornerstone PM is the Houzz Pro alternative for production home builders — AI agents, options engine, and multi-community management from $149/mo.",
  alternates: { canonical: "https://www.cornerstonepm.ai/houzz-alternative" },
};

const comparisonRows: ComparisonRow[] = [
  { feature: "Built for production home builders", cornerstone: true, competitor: false, note: "Houzz Pro is built for interior designers, remodelers, and home improvement pros. Cornerstone PM is purpose-built for production (tract/spec) home builders managing communities of homes." },
  { feature: "Structural options engine", cornerstone: true, competitor: false, note: "Pre-sale floorplan options pricing matrix — not a design/remodel concept." },
  ...
  { feature: "Designer Packages (64 curated, 7 categories)", cornerstone: true, competitor: false, note: "Production builder design center with curated buyer selection packages." },
  { feature: "Native AI agents (Foreman AI — 45+ skills)", cornerstone: true, competitor: false, note: "Foreman AI reads AND writes data. Blueprint AI: PDF to takeoff in 60 seconds. Houzz Pro has no native AI agents." },
  ...
  { feature: "Public REST API (59 endpoints)", cornerstone: true, competitor: false, note: "Cornerstone: 59 endpoints, public docs. Houzz Pro has no public API." },
  ...
  { feature: "Starting price", cornerstone: "$149/mo", competitor: "$149/mo+", note: "Similar entry price. Cornerstone is a full production builder platform; Houzz Pro is a design/remodel tool." },
];
...
const faqItems: FAQItem[] = [
  {
    q: "Is Houzz Pro a good fit for production home builders?",
    a: "Houzz Pro is designed for interior designers, kitchen and bath remodelers, and home improvement contractors who need a portfolio website, lead generation from the Houzz marketplace, and project management for one-off renovation projects. If you're a production home builder managing lot inventories, multiple floorplans, pre-sale design centers, and multi-community construction schedules, Houzz Pro lacks the specialized features you need.",
  },
  {
...
export default function HouzzAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      badgeLabel="Houzz Pro Alternative — Production Builders"
      heroLine1="Houzz is for designers."
      heroLine2="You build communities."
      accentColor="violet"
      heroParagraph="Houzz Pro is a design platform and marketplace for interior designers and remodelers. Cornerstone PM is the alternative for production new home builders — structural options engine, floorplan pricing matrix, multi-community lot management, and 45+ AI skills from $149/mo."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="Houzz Pro vs Cornerstone PM — design platform vs. production builder platform."
      comparisonRows={comparisonRows}
      trademarkName="Houzz"
      whySwitchHeadline="What production builders get with Cornerstone PM"
      whySwitchCards={whySwitchCards}
      honestAngle="If you're an interior designer or home remodeler, Houzz Pro is a great tool for portfolio building and lead generation from the Houzz marketplace. This page is for production home builders who found Houzz Pro through a search — you need a different kind of platform, and Cornerstone PM is built for your workflows."
      ...
      faqSubtitle="For production home builders evaluating Houzz Pro vs Cornerstone PM."
      faqItems={faqItems}
      footerHeadline="Built for production builders, not design portfolios."
