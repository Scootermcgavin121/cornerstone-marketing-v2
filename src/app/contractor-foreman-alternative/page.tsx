...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Foreman AI is Cornerstone PM's native AI agent with 45+ skills specific to home building. It reads AND writes your data - creates purchase orders, updates design options, generates scope-of-work documents, runs bid comparisons, searches product images (with anti-bot web scraping for Home Depot/Ferguson/Lowe's). And it learns YOU - greets you by whatever name you want to be called, remembers your role, your go-to vendors, your typical workflows, your reporting preferences. Custom-coded into the app, not a generic chatbot bolt-on. Gets more intuitive every session. Contractor Foreman has no equivalent AI capability.",
  },
  {
