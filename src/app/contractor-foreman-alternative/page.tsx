...
export const metadata = {
  ...
  description:
    "Contractor Foreman is general construction PM software. Cornerstone PM is the alternative for home builders — AI agents (Pro $499/mo), options engine, 30 webhook events, and multi-community management from $149/mo.",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "AI image search + anti-bot web scraping", cornerstone: true, competitor: false, note: "Foreman searches product images, permanently hosts them on CDN, and reads Home Depot/Ferguson/Lowe's product pages with AI-powered web scraping. Cornerstone Pro feature." },
  { feature: "30 webhook events (full named catalog)", cornerstone: true, competitor: false, note: "Cornerstone Pro+ ($599/mo): 30 named events with typed payloads, HMAC signatures, delivery logs, auto-retry. Contractor Foreman has no public webhook catalog." },
  ...
  { feature: "Public REST API (59 endpoints)", cornerstone: true, competitor: false, note: "Cornerstone Pro+: 59 endpoints, public docs. Contractor Foreman has no public REST API (Zapier integrations only)." },
  ...
  { feature: "Starter price", cornerstone: "$149/mo", competitor: "$49/mo (1 user)", note: "Cornerstone Starter: scheduling, permits, homeowner portal — unlimited users. Contractor Foreman Basic: $49/mo for 1 user only. Standard $105/mo (3 users), Plus $166/mo (8 users), Pro $221/mo (15 users), Unlimited $332/mo." },
  { feature: "Full platform price (Builder)", cornerstone: "$299/mo", competitor: "No equivalent (GC-focused)", note: "Cornerstone Builder ($299/mo) adds options engine, design center, sales pipeline — home-builder native. Contractor Foreman has no options engine or design center at any price." },
  { feature: "Price at full AI tier (Pro)", cornerstone: "$499/mo", competitor: "No AI available", note: "Cornerstone Pro ($499/mo) adds Foreman AI (45+ skills) + Blueprint AI — flat, unlimited users. Contractor Foreman has no native AI at any tier." },
];
