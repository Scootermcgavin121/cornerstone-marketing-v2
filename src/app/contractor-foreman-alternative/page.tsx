...
export const metadata = {
  title: "Contractor Foreman Alternative for Home Builders | Cornerstone PMTM",
  description:
    "Contractor Foreman is general construction PM software. Cornerstone PMTM is the alternative for home builders - AI agents (Pro $499/mo), options engine, 37+ named webhook events, and multi-community management from $149/mo.",
  alternates: { canonical: "https://www.cornerstonepm.ai/contractor-foreman-alternative" },
};

const comparisonRows: ComparisonRow[] = [
  { feature: "Built for home builders", cornerstone: true, competitor: false, note: "Contractor Foreman is general construction PM software for various contractor types. Cornerstone PMTM is purpose-built for home builders - production, semi-custom, and custom - with lot management, options engine, and multi-community pipelines that GC tools don't offer." },
...
const whySwitchCards: WhySwitchCard[] = [
  ...
  { title: "MCP server, 37+ webhooks + public REST API (Pro+)", desc: "Built-in MCP server (connect Claude Desktop, Cursor, or Windsurf in ~30 seconds), 37+ named webhook events with typed payload schemas, HMAC signatures, and auto-retry (catalog growing). Public REST API with 150+ API endpoints - all on Pro+ ($599/mo). Wire SMS, voice (Twilio, Bland, Retell), or your own Claude agent to construction events. Contractor Foreman has no public API, webhook catalog, or MCP server." },
];

const faqItems: FAQItem[] = [
  {
    q: "How is Cornerstone PMTM different from Contractor Foreman?",
    a: "Both are construction management platforms, but they serve different builders. Contractor Foreman is built for general contractors doing varied work (commercial, residential, renovation) and competes on breadth of features at low price. Cornerstone PMTM is purpose-built for home builders - it adds a structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community lot management, native AI agents (Foreman AI 396+ skills on Pro $499/mo), 37+ named webhook events (Pro+), and a public REST API (Pro+) that Contractor Foreman doesn't offer at any price.",
  },
  {
    q: "What's the best Contractor Foreman alternative for home builders?",
    a: "Cornerstone PMTM is purpose-built for home builders. Where Contractor Foreman handles general contractor workflows (scheduling, POs, job costing, basic client portal), Cornerstone adds a structural options engine, pre-sale design center with 64 Designer Packages curated by an actual interior designer, multi-community pipelines, native AI agents (Foreman AI 396+ skills on Pro $499/mo, Blueprint AI), 37+ named webhook events (Pro+), and a public REST API (Pro+).",
  },
  {
    q: "Does Cornerstone PMTM have Contractor Foreman's core features?",
    a: "Yes - Cornerstone PMTM covers Gantt scheduling with dependencies, job costing and budgets, purchasing and POs, document management, and up to 30 users (60 on Pro+). It adds home-builder-specific features on top: floorplan pricing matrix, structural options engine, design center, multi-community lot management, native AI agents, and a 37-event webhook system.",
  },
  {
  ...
  {
    q: "Can I migrate from Contractor Foreman to Cornerstone PMTM?",
  ...
  },
  {
    ...
    a: "No - Foreman AI is Cornerstone PMTM's native AI agent, and the name comes from the construction industry term 'foreman' (the supervisor who knows every trade). Contractor Foreman is a completely separate company. Our Foreman AI is unaffiliated with Contractor Foreman Inc.",
  },
  {
  ...
  {
    q: "Does Cornerstone PMTM have a free trial?",
...
export default function ContractorForemanAlternativePage() {
  return (
    <AlternativePageTemplate
      ...
      accentColor="emerald"
      heroParagraph="Contractor Foreman is built for general contractors doing varied work across markets. Cornerstone PMTM is purpose-built for home builders - structural options engine (Builder $299/mo), floorplan pricing matrix, multi-community pipelines, Foreman AI with 396+ skills (Pro $499/mo), and 37+ named webhook events (Pro+). From $149/mo with up to 30 users (60 on Pro+)."
      secondaryCTA={{ text: "See full comparison", href: "/compare" }}
      comparisonSubtitle="Contractor Foreman vs Cornerstone PMTM - general contractor tool vs. home-builder platform."
      comparisonRows={comparisonRows}
      trademarkName="Contractor Foreman"
      whySwitchHeadline="Why home builders choose Cornerstone PMTM"
      ...
      faqSubtitle="Common questions from home builders evaluating Contractor Foreman vs Cornerstone PMTM."
      faqItems={faqItems}
